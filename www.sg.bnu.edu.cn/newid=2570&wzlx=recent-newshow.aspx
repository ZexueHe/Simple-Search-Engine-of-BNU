...
<div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[著作]孙宇：《互联网笔记》</span></span>
                            </h3>
	...
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">《互联网笔记》（Internet @ Us: The Reflective Light for a Society）以随笔和插画的形式，评点了互联网在技术、经济、社会、治理及伦理各方面、各层次诱发的新现象，剖析了现实世界和虚拟空间的交织融合、阴阳互动。</span> 
</p>
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">互联网——当代人类文明生态的基础要件，它仿佛是一面镜子抑或一双眼睛，实则是一种精神、一种走向未来的气质。</span> 
</p>
<hr />
<p>
	<br />
...
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">互联网笔记[M].北京：电子工业出版社.2016.</span> 
</p>
<br /></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=2569&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：周小平：《房地产投资分析（第2版）》</a>
