                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[著作]魏成龙：《政府规制创新》</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2016-05-25</span>
                                    点击率：<span id="Label4">44</span>
                                </span>
                            </h5>
                            <span id="Label3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size:14px;font-family:SimSun;line-height:1.5;">政府规制又称政府管制、政府监管，都有共同的涵义，即政府运用公共权力，通过制定一定的规则，或者通过某些具体的行动对个人和组织的行为进行限制与调控。本书重点讨论了政府规则中的合同规制、质量规制、激励性规制和农村金融规制。</span> 
<hr />
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">政府规制创新[M].北京：经济管理出版社.2016，4.</span> 
</p>
<br /></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=2559&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：王琼：《图书情报工作》——国外大学数据...</a>
