...
<div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[著作]肖明：《国内图书情报知识图谱实证研究》</span></span>
                            </h3>
	...
	本书既是作者主持的多项国家社科基金项目的研究成果，又是运用科学知识图谱与可视化方法，形象化展示国内图书馆学情报学学科知识的发展进程与结构关系的一部学术专著。全书共分为三篇七章内容，系统阐述了科学知识图谱的理论、方法及其在国内图书馆学、情报学领域中的实际应用，为科学知识图谱研究的完善以及图书馆学、情报学学科的发展提供科学依据和研究实例。本书结构合理、内容新颖、方法得当、应用面广，具有较强的系统性、科学性和实用性，既可作为国内高等院校信息管理与信息系统、管理科学与工程、信息资源管理、图书馆学、情报学、科学学与科技管理、科学学等专业的参考书，也可供广大图书情报档案工作者、科研人员以及管理者阅读和使用。。
</p>
<p style="text-indent:2em;">
	肖明.国内图书情报知识图谱实证研究[M].中国经济出版社, 2017, 03.
</p>
<p style="text-indent:2em;">
	<br />
</p></span>
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=4869&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：肖明：《网络计量学》</a>
                                
                            

                                    <a href="newshow.aspx?newid=4871&wzlx=recent" class="pres" style="float: right; width: 45%;">下一篇：王宏新：《全面深化改革中的土地政策创新...</a>
