                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]靳健：《数字图书馆论坛》——基于主题契合度的专家推荐模型研究</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-06-05</span>
                                    点击率：<span id="Label4">754</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	评审专家遴选是会议、期刊等投稿论文评审的一项重要步骤。本研究首先依据主题在学科中出现频率，分析待评审论文及候选专家论文的主题重要性，其次综合考虑主题重要性，构造整数优化模型以高效地为多篇待审文稿推荐评审专家。并加入专家专长与投稿论文的匹配度、评审专家权威性、评审专家工作量分配等因素以满足专家推荐的现实需求。最后从平均覆盖率、人均审核率和重要性匹配度三个角度对本模型的有效性进行验证，结果表明，提出的优化模型可以较好地完成专家推荐任务。
</p>
<p style="text-indent:2em;">
	<br />
</p>
<p style="text-indent:2em;">
	靳健、杨海慈、耿骞.基于主题契合度的专家推荐模型研究[J].数字图书馆论坛, 2017, (04)，47-55.
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=5943&wzlx=topic" class="pres" style="float: left; width: 45%;">上一篇：柯江林：《经济与管理研究》——精神智力...</a>
