                        ...
                        <div class="col-md-9 column pn col-sm-10 col-xs-12 ">
                            ...
                            <div class="ins_right">
                                <div class="row clearfix" style="margin-bottom: 4%">
                                    <h3 class="stu-title">ME训练营</h3>
                                    
                                            <div class="col-md-4 column ke">
                                                <div style="width: 100%">
                                                    <a  href="newshow.aspx?newid=8107&wzlx=yactivity" target="_blank">
                                                        <img src="/UploadFile/1712080404432502.jpg" title="" class="img-responsive" style="height:206px;" alt="Cinque Terre" />
                                                    </a>
                                                    <h4><a  href="newshow.aspx?newid=8107&wzlx=yactivity" target="_blank" >政府管理学院初级团校公文写...</a></h4>
                                                    <p style="width: 100%;height:40px;" > 	2017年12月5日晚18：30，政府管理学院初级团校在教二301...</p>
                                            ...
                                            <div class="col-md-4 column ke">
                                                <div style="width: 100%">
                                                    <a  href="newshow.aspx?newid=8015&wzlx=yactivity" target="_blank">
                                                        <img src="/UploadFile/1709261115089162.jpg" title="" class="img-responsive" style="height:206px;" alt="Cinque Terre" />
                                                    </a>
                                                    <h4><a  href="newshow.aspx?newid=8015&wzlx=yactivity" target="_blank" >我院研究生新生学术道德规范...</a></h4>
                                                    <p style="width: 100%;height:40px;" > 	为提升我院研究生学术道德和规范研究水平，营造良好的学术氛围，9月2...</p>
                                            ...
                                            <div class="col-md-4 column ke">
                                                <div style="width: 100%">
                                                    <a  href="newshow.aspx?newid=8014&wzlx=yactivity" target="_blank">
                                                        <img src="/UploadFile/1709261109463969.jpg" title="" class="img-responsive" style="height:206px;" alt="Cinque Terre" />
                                                    </a>
                                                    <h4><a  href="newshow.aspx?newid=8014&wzlx=yactivity" target="_blank" >你的形象，你的未来——政府...</a></h4>
                                                    <p style="width: 100%;height:40px;" > 	9月8日下午3点，我院在教四101教室成功举办了“你的形象，你的未...</p>

                                                </div>
                                            </div>
                                        
                                     <a  href="sdlist.aspx?cdid=yactivity&cdlx=mexly" class="btn" style="float: right">more</a>
                                </div>
                                
                                <!--1-->
                                <div class="row clearfix">
                                    <h3 class="stu-title">评选与通讯</h3>
                                    
                                            <div class="col-md-4 column ke">
                                              <div style="width: 100%">
                                                    <a  href="newshow.aspx?newid=2683&wzlx=yactivity" target="_blank">
                                                        <img src="images/she/1.jpg" title="" class="img-responsive" style="height:206px;"alt="Cinque Terre" />
                                                    </a>
                                                    <h4><a  href="newshow.aspx?newid=2683&wzlx=yactivity" target="_blank">政府管理学院2015—20...</a></h4>
                                                    <p style="width: 100%;height:40px;"> 	    经个人申请、团支部推举（学生组织及团体自评）及学院、学校审...</p>
                                 ...
                                 <a  href="sdlist.aspx?cdid=yactivity&cdlx=pxytx" class="btn" style="float: right">more</a>
