                ...
                <div class="col-md-12 column">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-9 column pn col-sm-10 col-xs-12 ">
                             <div class="url-title">
                                <b>  <span id="ctl00_ContentPlaceHolder1_Label5">实验室</span></b>
                                <ul class="breadcrumb">
                                    当前位置:
                            <li>
                                <a href="index.aspx">首页</a>
                                    ...
                                    <li class="active">
                                        <span id="ctl00_ContentPlaceHolder1_Label4">实验室</span>
                                    </li>
                                </ul>
                            </div>
                            <!--右边标题路径导航-->
                            <div class="ins_right">
                                  <div id="ctl00_ContentPlaceHolder1_rep1" class="row clearfix" style="margin-bottom: 4%;">
                                    <h3 style="text-align: center;">
                                        <img src="images/rencai/gaikaung.png" title="" class="img-responsive" alt="Cinque Terre" style="display: inline; width: 40%;" />
                                    </h3>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4874&wzlx=laboratory" target="_blank">京师政管创新实验室</a>
                                   ...
                                   <a href="personnelshow.aspx?lx=laboratory&zylx=labxm&cdss=25" class="btn" style="float: right">more</a>
                                </div>
                                  <div id="ctl00_ContentPlaceHolder1_rep2" class="row clearfix" style="margin-bottom: 4%;">
                                    <h3 style="text-align: center;">
                                        <img src="images/rencai/gonggao.png" title="" class="img-responsive" alt="Cinque Terre" style="display: inline; width: 40%;" />
                                    </h3>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4879&wzlx=laboratory" target="_blank">实验室第二批立项课题</a>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4878&wzlx=laboratory" target="_blank">实验室预约及设备使用公告</a>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4877&wzlx=laboratory" target="_blank">本期实验室课题资助对象公布</a>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4876&wzlx=laboratory" target="_blank">实验室公告</a>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4875&wzlx=laboratory" target="_blank">实验室场地小学期使用通知</a>
                                  ...
                                  <div id="ctl00_ContentPlaceHolder1_rep3" class="row clearfix" style="margin-bottom: 4%;">
                                    <h3 style="text-align: center;">
                                        <img src="images/rencai/xinwne.png" title="" class="img-responsive" alt="Cinque Terre" style="display: inline; width: 40%;" />
                                    </h3>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4880&wzlx=laboratory" target="_blank">我院“京师梦工厂学生创业基地” 揭牌仪式...</a>
                                  ...
                                  <div id="ctl00_ContentPlaceHolder1_rep4" class="row clearfix" style="margin-bottom: 4%;">
                                    <h3 style="text-align: center;">
                                        <img src="images/rencai/xiangmu.png" title="" class="img-responsive" alt="Cinque Terre" style="display: inline; width: 40%;" />
                                    </h3>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4894&wzlx=laboratory" target="_blank">亲其师”教育机构--学园计划</a>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4893&wzlx=laboratory" target="_blank">让成长伙伴走进万千家庭---DREAM ...</a>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4892&wzlx=laboratory" target="_blank">北京幕击影视工作室</a>
                                                            <span>2015-04-01</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4891&wzlx=laboratory" target="_blank">Web 2.0环境下学术影响力评价的实证...</a>
                                                            <span>2015-04-01</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4890&wzlx=laboratory" target="_blank">中国未来婚姻挤压的时空特征以及对策研究</a>
                                                            <span>2015-04-01</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4889&wzlx=laboratory" target="_blank">转型期政务微博应急管理功能及其有效性影响...</a>
                                                            <span>2015-04-01</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4888&wzlx=laboratory" target="_blank">反腐败有效性：中央巡视组与明朝巡按比较研...</a>
                                                            <span>2015-04-01</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4887&wzlx=laboratory" target="_blank">创客空间人才集聚的影响因素及驱动机制研究...</a>
                                                            <span>2015-04-01</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4886&wzlx=laboratory" target="_blank">外来NGO参与社区社会组织培育的一种探索...</a>
                                                            <span>2015-04-01</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4885&wzlx=laboratory" target="_blank">少数民族地区社会建设和社会管理模式探究-...</a>
                                                            <span>2015-04-01</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4884&wzlx=laboratory" target="_blank">搜易科技商业计划书</a>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4883&wzlx=laboratory" target="_blank">北京三国智教育科技有限公司</a>
                                                            <span>2014-04-01</span>
                                                        </li>
                                                    </ul>
                                                </div>
