                ...
                <div class="col-md-12 column">
                    <div class=" clearfix">
                        <div class="tab_content" id="tab1">
                            ...
                            <div class="steps_container parentclear">
                                <div class="steps_wrapper">
                                    <div class="steps">
                                        <a class="circle listen_icon"><span class="hover"></span><span class="icon"></span><span class="text">科研项目</span></a>
                                        <a  class="circle share_icon"><span class="hover"></span><span class="icon"></span><span class="text">学术论文</span></a>
                                        <a class="circle buy_icon"><span class="hover"></span><span class="icon"></span><span class="text">专著教材</span></a>
                                        <a  class="circle download_icon"><span class="hover"></span><span class="icon"></span><span class="text">研究报告</span></a>
                                        <a  class="circle download_icon"><span class="hover"></span><span class="icon"></span><span class="text">科研制度</span></a>
                                    </div>
                                </div>
                            </div>
                            <br />
                    ...
                    <div class="col-md-6 column ke">
                        <p class="keyan">
                            <img src="images/keyan/img_22.png" title="keyan" class="img-responsive" alt="Cinque Terre" />
                        </p>
                    </div>
                    <div class="col-md-6 column ke">
                        <h3 class="blue">学术科研
                   <span>Research</span>
                     ...
                     <a  href="sddlist.aspx?cdid=research" class="btn" style="float: right">more</a>
                </div>
            </div>
        </div>
    </section>
