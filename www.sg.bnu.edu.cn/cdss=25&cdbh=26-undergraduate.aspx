                ...
                <div class="col-md-12 column">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-9 column pn col-sm-10 col-xs-12 ">
                            <div class="url-title">
                                <b>
                                    <span id="ctl00_ContentPlaceHolder1_Label5">本科生</span></b>
                                <ul class="breadcrumb">
                                    当前位置:
                            <li>
                                <a href="index.aspx">首页</a>
                                    ...
                                    <li class="active">
                                        <span id="ctl00_ContentPlaceHolder1_Label4">本科生</span>
                                    </li>
                                </ul>
                            </div>
                            <!--右边标题路径导航-->
                            ...
                            <div class="ins_right">
                                <div id="ctl00_ContentPlaceHolder1_rep1" class="row clearfix" style="margin-bottom: 4%;">
                                    <h3 style="text-align: center;">
                                        <img src="images/rencai/zhuanyejieshao.png" title="" class="img-responsive" alt="Cinque Terre" style="display: inline; width: 40%;" />
                                    </h3>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2378&wzlx=undergraduate" target="_blank">公共事业管理</a>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2377&wzlx=undergraduate" target="_blank">管理科学</a>
                                                            <span>2017-04-06</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2376&wzlx=undergraduate" target="_blank">人力资源管理</a>
                                                            <span>2017-04-06</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2375&wzlx=undergraduate" target="_blank">信息管理与信息系统</a>
                                    ...
                                    <a href="personnelshow.aspx?lx=undergraduate&zylx=bzyjs&cdss=25" class="btn" style="float: right">more</a>
                                </div>
                                <div id="ctl00_ContentPlaceHolder1_rep2" class="row clearfix" style="margin-bottom: 4%;">
                                    <h3 style="text-align: center;">
                                        <img src="images/rencai/zhaoshengxuanchuan.png" title="" class="img-responsive" alt="Cinque Terre" style="display: inline; width: 40%;" />
                                    </h3>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2393&wzlx=undergraduate" target="_blank">2016年本科招生报考指南</a>
                                    ...
                                    <a href="personnelshow.aspx?lx=undergraduate&zylx=bzsxc&cdss=25" class="btn" style="float: right">more</a>
                                </div>
                                <div id="ctl00_ContentPlaceHolder1_rep3" class="row clearfix" style="margin-bottom: 4%;">
                                        ...
                                        <img src="images/rencai/pyfa.png" title="" class="img-responsive" alt="Cinque Terre" style="display: inline; width: 40%;" />
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4834&wzlx=undergraduate" target="_blank">人力资源管理本科专业2015年培养方案</a>
                                                            <span>2017-04-06</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2390&wzlx=undergraduate" target="_blank">管理科学专业2015年本科培养方案</a>
                                                            <span>2017-04-06</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2388&wzlx=undergraduate" target="_blank">信息管理与信息系统专业2015年本科培养...</a>
                                                            <span>2017-04-06</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2386&wzlx=undergraduate" target="_blank">公共事业管理专业2015年本科培养方案</a>
                                    ...
                                    <a href="personnelshow.aspx?lx=undergraduate&zylx=bjxjh&cdss=25" class="btn" style="float: right">more</a>
                                </div>
                                <div id="ctl00_ContentPlaceHolder1_rep4" class="row clearfix" style="margin-bottom: 4%;">
                                    <h3 style="text-align: center;">
                                        <img src="images/rencai/jiuyequxiang.png" title="" class="img-responsive" alt="Cinque Terre" style="display: inline; width: 40%;" />
                                    </h3>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2373&wzlx=undergraduate" target="_blank">政府管理学院近年本科毕业生就业去向</a>
                                    ...
                                    <a href="personnelshow.aspx?lx=undergraduate&zylx=bjyqx&cdss=25" class="btn" style="float: right">more</a>
                                </div>
                            </div>
                        </div>
                        <!--右边-->
