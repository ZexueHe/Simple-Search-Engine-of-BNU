...
<div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]肖明：《图书馆学研究》——近3年基于本体的国外知识管理研究综述</span></span>
                            </h3>
	...
	国外学者在研究过程中经常将本体与知识管理联系起来,将本体应用到知识管理领域已引起诸多研究领域学者的关注,并取得不少研究成果。文章选取Scopus数据库为数据源,采用词频统计法对检索得到的文献关键词进行统计,从基于本体的知识表示、基于本体的知识管理系统构建、基于本体的数据挖掘3个方面系统研究了国外近3年本体在知识管理研究中的应用情况。
</p>
<p style="text-indent:2em;">
	<a></a>肖明、王珊珊. 近3年基于本体的国外知识管理研究综述[J].图书馆学研究,
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=8047&wzlx=topic" class="pres" style="float: left; width: 45%;">上一篇：汪波：《中国高校社会科学》——中国人大...</a>
                                
                            

                                    <a href="newshow.aspx?newid=8049&wzlx=topic" class="pres" style="float: right; width: 45%;">下一篇：章文光：《湘潭大学学报（哲学社会科学版...</a>
