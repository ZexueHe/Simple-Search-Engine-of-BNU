                ...
                <div class="col-md-12 column">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-9 column pn">
                            <div class="url-title">
                                <b>
                                    <span id="ctl00_ContentPlaceHolder1_Label5">系所介绍</span></b>
                                <ul class="breadcrumb">
                                    当前位置:
                            <li>
                                <a href="index.aspx">首页</a>
                                    ...
                                    <li class="active">
                                        <span id="ctl00_ContentPlaceHolder1_Label4">系所介绍</span>
                                    </li>
                                </ul>
                            </div>
                            <!--右边标题路径导航-->
                            <article>
                                <div class="ins_right">
                                    <div class="row clearfix">
                                        <div class="col-md-4 column col-sm-6 col-xs-12 pro_list">
                                            <dl>
                                                <dt><a href="Departmentsee.aspx?deparlx=xingzhenggl">
                                                    <img src="images/about/xi_03.png" width="100%" height="170" /></a></dt>
                                                <dd><a href="Departmentsee.aspx?deparlx=xingzhenggl" target="_blank" class="fontsize22 yellow">行政管理系</a></dd>
                                            </dl>
                                        </div>

                                        <div class="col-md-4 column col-sm-6 col-xs-12 pro_list">
                                            <dl>
                                                <dt><a href="Departmentsee.aspx?deparlx=zuzhigl">
                                                    <img src="images/about/xi_05.png" width="100%" height="170" /></a></dt>
                                                <dd><a href="Departmentsee.aspx?deparlx=zuzhigl" target="_blank" class="fontsize22 yellow">组织与人力资源管理系</a></dd>
                                            </dl>
                                        </div>

                                        <div class="col-md-4 column col-sm-6 col-xs-12 pro_list">
                                            <dl>
                                                <dt><a href="Departmentsee.aspx?deparlx=xinxigl">
                                                    <img src="images/about/xi_07.png" width="100%" height="170" /></a></dt>
                                                <dd><a href="Departmentsee.aspx?deparlx=xinxigl" target="_blank" class="fontsize22 yellow">信息管理系</a></dd>
                                            </dl>
                                        </div>

                                        <div class="col-md-4 column col-sm-6 col-xs-12 pro_list">
                                            <dl>
                                                <dt><a href="Departmentsee.aspx?deparlx=tudigl">
                                                    <img src="images/about/xi_13.png" width="100%" height="170" /></a></dt>
                                                <dd><a href="Departmentsee.aspx?deparlx=tudigl" target="_blank" class="fontsize22 yellow">土地资源管理研究所</a></dd>
                                            </dl>
                                        </div>

                                        <div class="col-md-4 column col-sm-6 col-xs-12 pro_list">
                                            <dl>
                                                <dt><a href="Departmentsee.aspx?deparlx=zhengzhigl">
                                                    <img src="images/about/xi_15.png" width="100%" height="170" /></a></dt>
                                                <dd><a href="Departmentsee.aspx?deparlx=zhengzhigl" target="_blank" class="fontsize22 yellow">政治学研究所</a></dd>
                                            </dl>
                                        </div>

                                        <div class="col-md-4 column col-sm-6 col-xs-12 pro_list">
                                            <dl>
                                                <dt><a href="Departmentsee.aspx?deparlx=guojigl">
                                                    <img src="images/about/xi_16.png" width="100%" height="170" /></a></dt>
                                                <dd><a href="Departmentsee.aspx?deparlx=guojigl" target="_blank" class="fontsize22 yellow">国际关系研究所</a></dd>
                                            </dl>
                                        </div>
                                    </div>
                            </article>
