                ...
                <div class="col-md-12 column">
                    <div class="row clearfix">
                        <div class="col-md-3 column  col-sm-2 col-xs-4">
                            <div class="content">
                                <h3 class="title">
                                    <span id="ctl00_ContentPlaceHolder1_Label4">校园活动</span>
                                </h3>
                            ...
                            <li>
                                <a href="index.aspx">首页</a>
                                    ...
                                    <li id="ctl00_ContentPlaceHolder1_xian">
                                        ...
                                        <span id="ctl00_ContentPlaceHolder1_Label3">校友之窗</span>
                                    </li>
                                    <li class="active">
                                        <span id="ctl00_ContentPlaceHolder1_Label1">校园活动</span>
                                    </li>
                                </ul>
                            </div>
                            <!--右边标题路径导航-->
                                ...
                                <div class="row clearfix" style="margin-bottom: 4%">
                                    <div class="ann-bg" style="background: none; margin-top: 0; min-height: 0">
                                                ...
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="newshow.aspx?newid=8021&wzlx=alumni" target="_blank" class="">03级人力资源管理专业院友毕业十周年返校活动顺利举办</a>
                                                ...
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="newshow.aspx?newid=8020&wzlx=alumni" target="_blank" class="">07级信息管理专业院友返校活动顺利举办</a>
                                                        <span>2017-09-26</span>
                                                    </li>
                                                </ul>
                                                ...
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="newshow.aspx?newid=6971&wzlx=alumni" target="_blank" class="">政府管理学院2017届毕业生合影下载</a>
                                                ...
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="newshow.aspx?newid=1120&wzlx=alumni" target="_blank" class="">我院成功举办2014级MPA“相聚杯”羽毛球友谊赛</a>
                                                ...
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="newshow.aspx?newid=1119&wzlx=alumni" target="_blank" class="">我院成功举办2014级MPA新生成长交流会</a>
                                                        <span>2016-12-28</span>
                                                    </li>
                                                </ul>
                                                ...
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="newshow.aspx?newid=1118&wzlx=alumni" target="_blank" class="">北京高校MPA羽毛球比赛圆满结束</a>
                                                        <span>2016-12-28</span>
                                                    </li>
                                                </ul>
