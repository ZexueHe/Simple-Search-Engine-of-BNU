                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]耿骞：《数字图书馆论坛》——科学数据引用规范的内容特点分析</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-07-10</span>
                                    点击率：<span id="Label4">779</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	本文选取科学数据组织机构所拟定的、面向科学数据引用的规范性文本为研究对象，从科学数据引用对象、科学数据引用元素、科学数据引用格式、科学数据引用的标识符等方面，分析科学数据引用规范的内容特点。研究发现，现有科学数据引用规范内容多遵循科学数据引用原则，且受传统规范影响较大，但在引用对象、引用元素与引用格式等方面存在差异。
</p>
<p style="text-indent:2em;">
	<br />
</p>
<p style="text-indent:2em;">
	邸弘阳、耿骞、黄国彬、屈亚杰.科学数据引用规范的内容特点分析[J].数字图书馆论坛, 2017, (06)，09-15.
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=6973&wzlx=topic" class="pres" style="float: left; width: 45%;">上一篇：黄国彬：《数字图书馆论坛》——影响科学...</a>
                                
                            

                                    <a href="newshow.aspx?newid=6975&wzlx=topic" class="pres" style="float: right; width: 45%;">下一篇：黄国彬：《数字图书馆论坛》——基于re...</a>
