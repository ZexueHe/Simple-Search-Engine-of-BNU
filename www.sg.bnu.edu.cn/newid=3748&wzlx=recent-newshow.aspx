                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]周晓燕：《大学图书馆学报》——国外高校图书馆的服务空问拓展研究</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-03-20</span>
                                    点击率：<span id="Label4">242</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	数字化环境下,图书馆的服务空间面临着巨大变革,国外高校图书馆通常通过制定战略规划来明确图书馆空间的未来发展方向,因此通过对高校图书馆战略规划的调研,可以了解国外高校图书馆空间设计的发展趋势.文章调研了2016年《美国新闻和世界报导》发布的世界大学排行榜中排名靠前的19所大学的图书馆的战略规划,采用网站调研法、统计分析法,获得了国外高校图书馆服务空间拓展的战略目标,包括:满足用户需求、创建高质量的图书馆空间、发展图书馆虚拟空间、保护特色馆藏等,继而从动态评估图书馆空间、与用户共同规划图书馆空间、建设图书馆虚拟空间、拓展图书馆物理空间这四个角度分析了国外高校图书馆服务空间的拓展趋势。
</p>
<p style="text-indent:2em;">
	<br />
</p>
<p style="text-indent:2em;">
	周晓燕、吴媛媛.国外高校图书馆的服务空问拓展研究[J].大学图书馆学报, 2016, (01)，40-45.
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=3739&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：程惠霞：《中国行政管理》——明代巡按御...</a>
