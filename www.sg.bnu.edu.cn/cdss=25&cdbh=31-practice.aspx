                ...
                <div class="col-md-12 column">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-9 column pn col-sm-10 col-xs-12 ">
                            <div class="url-title">
                                <b>  <span id="ctl00_ContentPlaceHolder1_Label5">实习基地</span></b>
                                <ul class="breadcrumb">
                                    当前位置:
                            <li>
                                <a href="index.aspx">首页</a>
                                    ...
                                    <li class="active">
                                        <span id="ctl00_ContentPlaceHolder1_Label4">实习基地</span>
                                    </li>
                                </ul>
                            </div>
                            <!--右边标题路径导航-->
		...
		<td>
                                            <div class="col-md-4 column">
                                                <div class="span3" style="text-align: left">
                                                    <img class="round_image img-responsive" src="images/46.jpg" alt="Example image" />
                                                    <h4 class="colored">学院建立实习基地的用意及方法介绍</h4>
                                                    <p> 	    1、整合资源    	     充分整合学院...</p>
                                                    <div class="button button_shadow">
                                                        <a href="newshow.aspx?newid=1076&wzlx=practice" target="_blank" class="button1 button_arrow_right">详情</a>
                                                    </div>
                                                </div>
                                        </td><td>
                                            <div class="col-md-4 column">
                                                <div class="span3" style="text-align: left">
                                                    <img class="round_image img-responsive" src="images/46.jpg" alt="Example image" />
                                                    <h4 class="colored">政府管理学院学生实习主要参与单位</h4>
                                                    <p> 	 		 			 				 					外交部干部司  ...</p>
                                                    <div class="button button_shadow">
                                                        <a href="newshow.aspx?newid=1075&wzlx=practice" target="_blank" class="button1 button_arrow_right">详情</a>
                                                    </div>
                                                </div>
                                        </td><td></td><td></td>
	</tr>
