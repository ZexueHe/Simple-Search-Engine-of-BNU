                ...
                <div id="right_center" class="right_center3 anli_lineheight" style="background: #fff; width: 97%; margin: 2% auto; border-radius: 5px; border: 1px solid #DCE6F0;">
                       <div class="program_dl" style="width: 90%; margin: 0 auto">
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]靳健：《 Engineering Applications of Artificial Intelligence》——Translating Online Customer Opinions into Engineering Characteristics in QFD:</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2"></span>
                                    点击率：<span id="Label4"></span>
                                </span>
                            </h5>
                            <span id="Label3"></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=2442&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：靖培栋：《图书情报工作》——基于下一代...</a>
                                
                            

                                    <a href="newshow.aspx?newid=2444&wzlx=recent" class="pres" style="float: right; width: 45%;">下一篇：程惠霞：《中国行政管理》——公民参与中...</a>
