...
<div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]孙宇：《中国行政管理》——互联网治理的模型、话语及其争论</span></span>
                            </h3>
	...
	本文归纳了迄今为止出现的五种互联网治理模型——自我演化制序模型、编码模型、跨国机构和国际组织模型、国家管制模型和市场激励模型；剖析了不同治理模型潜藏的话语导向，这些话语导向包括网络化治理、基于共同体的对等生产方式和多方利益相关者主义。基于模型和话语的争论，本文提出了互联网治理的五点思考。
</p>
<p style="text-indent:2em;">
	<br />
</p>
<p style="text-indent:2em;">
	孙宇.互联网治理的模型、话语及其争论[J].中国行政管理, 2017, (05)，68-73.
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=5941&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：王琼：《大学图书馆学报》——数据监护人...</a>
