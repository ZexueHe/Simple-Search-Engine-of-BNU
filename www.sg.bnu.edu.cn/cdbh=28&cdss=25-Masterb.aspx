                           ...
                           <div class="url-title">
                            ...
                            <div class="ins_right">
                                <div id="ctl00_ContentPlaceHolder1_rep1" class="row clearfix" style="margin-bottom: 4%;">
                                        ...
                                        <img src="images/rencai/zhuanyejieshao.png" title="" class="img-responsive" alt="Cinque Terre" style="display: inline; width: 40%;" />
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4815&wzlx=Masterb" target="_blank">人力资源管理</a>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4814&wzlx=Masterb" target="_blank">土地资源管理</a>
                                                            <span>2017-04-06</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2595&wzlx=Masterb" target="_blank">政府经济管理</a>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2594&wzlx=Masterb" target="_blank">行政管理</a>
                                                            <span>2017-04-10</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                    ...
                                    <a href="personnelshow.aspx?lx=Masterb&zylx=mzyjs&cdss=25" class="btn" style="float: right">more</a>
                                </div>
                                <div id="ctl00_ContentPlaceHolder1_rep2" class="row clearfix" style="margin-bottom: 4%;">
                                    ...
                                    <a href="personnelshow.aspx?lx=Masterb&zylx=mpyfa&cdss=25" class="btn" style="float: right">more</a>
                                </div>
