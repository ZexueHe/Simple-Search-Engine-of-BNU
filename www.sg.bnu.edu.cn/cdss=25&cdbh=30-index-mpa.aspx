                        ...
                        <div class="col-md-9 column pn col-sm-10 col-xs-12 ">
                            ...
                            <div class="ins_right">
                                <div id="ctl00_ContentPlaceHolder1_rep1" class="row clearfix" style="margin-bottom: 4%;">
                                    ...
                                    <a href="personnelshow.aspx?lx=indexmpa&zylx=mpags&cdss=25" class="btn" style="float: right">more</a>
                                </div>
                                <div id="ctl00_ContentPlaceHolder1_rep2" class="row clearfix" style="margin-bottom: 4%;">
                                    ...
                                    <a href="personnelshow.aspx?lx=indexmpa&zylx=mpazsypy&cdss=25" class="btn" style="float: right">more</a>
                                </div>
                                <div id="ctl00_ContentPlaceHolder1_rep3" class="row clearfix" style="margin-bottom: 4%;">
                                    ...
                                    <a href="personnelshow.aspx?lx=indexmpa&zylx=mpaszll&cdss=25" class="btn" style="float: right">more</a>
                                </div>
                                <div id="ctl00_ContentPlaceHolder1_rep4" class="row clearfix" style="margin-bottom: 4%;">
                                    ...
                                    <a href="personnelshow.aspx?lx=indexmpa&zylx=mpahuodong&cdss=25" class="btn" style="float: right">more</a>
                                </div>
                            </div>
                        </div>
                        <!--右边-->
