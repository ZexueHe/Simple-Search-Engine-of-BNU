                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">政府管理学院博士后进站遴选指标</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2014-03-05</span>
                                    点击率：<span id="Label4">331</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="font-family:宋体;font-size:16px;text-align:justify;text-indent:2em;background:white;">
	<p class="MsoNormal">
		<b>政府管理学院博士后进站遴选指标：<span></span></b>
	</p>
	<p class="MsoNormal" style="text-indent:12.0pt;">
		1、在境内外一流大学获得博士学位、品学兼优、身体健康，年龄在<span>35</span>周岁以下。<span></span>
	</p>
	<p class="MsoNormal" style="text-indent:12.0pt;">
		2、能够保证在站期间全职在校工作，不招收在职人员。<span></span>
	</p>
	<p class="MsoNormal" style="text-indent:12.0pt;">
		3、近五年有较高水平的科研成果产出，须符合以下条件之一：<span></span>
	</p>
	<p class="MsoNormal" style="text-indent:6.0pt;">
		（<span>1</span>）主持省部级科研项目，并取得重要的阶段成果；<span></span>
	</p>
	<p class="MsoNormal" style="text-indent:6.0pt;">
		（<span>2</span>）以第一作者或通讯作者发表高水平原创性研究成果，必须在<span>B</span>类及以上期刊（或<span>SSCI</span>—<span>Q1</span>区）发表论文<span>1</span>篇，或者<span>C</span>类及以上期刊发表论文<span>2</span>篇，或<span>CSSCI</span>期刊发表论文至少<span>3</span>篇。<span></span>
	</p>
</p></span>
                        </div>
