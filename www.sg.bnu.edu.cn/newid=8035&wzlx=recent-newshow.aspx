...
<div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]杨冠琼：《中国行政管理》——国家治理的博弈论研究途径与理论洞见</span></span>
                            </h3>
	...
	国家治理体系是多个体复杂互动形成的、具有不同性质与特征的、众多局部公共治理博弈及其均衡构成的复杂嵌套体系。公共治理博弈的不同嵌套关系导致公共治理的全局博弈与局部博弈间呈现错综复杂的关系,因而形成大量作为治理机制的性质不同于全局均衡的局部均衡。任何稳定的博弈均衡都具有自我实施性与自我强化性,因而能够有效发挥协调功能与提高治理能力。国家治理体系现代化是个体间互动形成的公共治理博弈的间断-均衡过程。实现国家治理体系与能力现代化,必须首先通过完善国家治理体系的适度弱耦合结构,改变博弈参与人的个性特征、互动结构与行为选择,形成具有自我实施性与自我强化性的、动员与治理能力更强的国家治理体系,逐步实现国家治理体系与能力的现代化。
</p>
<p style="text-indent:2em;">
	杨冠琼、刘雯雯.国家治理的博弈论研究途径与理论洞见[J].中国行政管理, 2017, (06)，54-61.
</p>
<p style="text-indent:2em;">
	<br />
</p></span>
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=8034&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：王颖：《浙江大学学报（人文社会科学版）...</a>
                                
                            

                                    <a href="newshow.aspx?newid=8036&wzlx=recent" class="pres" style="float: right; width: 45%;">下一篇：孙宇：《行政管理改革》——“互联网+政...</a>
