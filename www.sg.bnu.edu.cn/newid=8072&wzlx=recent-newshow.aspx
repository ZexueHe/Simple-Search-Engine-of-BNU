...
<div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[著作]肖明：《图书馆学情报学知识图谱研究理论、方法与应用》</span></span>
                            </h3>
	...
	科学知识图谱是以科学知识为对象，显示学科的发展进程与机构关系的一种图形具有图和谱的双重特性。通过知识图谱，可以直观、形象地展示某个学科或特定领域的内容结构、发展历程、演化与趋势，为科学研究提供方向和指南。因此，如何从知识图谱出发，通过对学科结构和前沿的把握来推动科学研究的发展，是政府管理部门和学术界十分关注的重要课题之一。
</p>
<p style="text-indent:2em;">
	肖明.图书馆学情报学知识图谱研究理论、方法与应用[M]中国书籍出版社, 2017, 05.
</p>
<p style="text-indent:2em;">
	<br />
</p></span>
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=8070&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：孙宇：《电子政务》（第2版）</a>
                                
                            

                                    <a href="newshow.aspx?newid=8073&wzlx=recent" class="pres" style="float: right; width: 45%;">下一篇：郑雄飞：《中国行政管理》—我国侨民社会...</a>
