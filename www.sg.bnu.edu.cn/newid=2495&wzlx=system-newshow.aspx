	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWAwKOo6L3DALs0bLrBgLSwpnTCJLXLswkQ+IM8NdlrAAydeXJ4qTl" />
        ...
        <section>
            <div class="container" style="width: 980px; margin: 0% auto; background-color: #fff; border-radius: 3px">
                <div style="width: 97%; margin: 1% auto; text-align: right">当前位置：<a href="index.aspx">首页</a>-><span id="Label5">科研制度</span>->正文</div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">理科论文核心期刊目录</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2013-09-09</span>
                                    点击率：<span id="Label4">403</span>
                                </span>
                            </h5>
                            <span id="Label3"><div style="text-align:left;">
	<a class="ke-insertfile" href="http://www.sg.bnu.edu.cn/attached/file/20130909/20130909095117_662.doc" target="_blank"><span style="font-size:14px;font-family:SimSun;">理科论文核心期刊目录</span></a> 
</div></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=2496&wzlx=system" class="pres" style="float: right; width: 45%;">下一篇：文科论文核心期刊目录</a>
