...
职位要求
	<div id="maskit">
		...
		<p style="margin-left:28px;">
			<span style="font-family:宋体;font-size:14px;">1.&nbsp;</span><span style="font-family:宋体;font-size:14px;">本科学历，英语四级；</span>
		</p>
		<p style="margin-left:28px;">
			<span style="font-family:宋体;font-size:14px;">2.&nbsp;</span><span style="font-family:宋体;font-size:14px;">思路清晰</span><span style="font-family:宋体;font-size:14px;">，具备</span><span style="font-family:宋体;font-size:14px;">较强分析解决问题</span><span style="font-family:宋体;font-size:14px;">的</span><span style="font-family:宋体;font-size:14px;">能力；</span>
		</p>
		<p style="margin-left:28px;">
			<span style="font-family:宋体;font-size:14px;">3.&nbsp;</span><span style="font-family:宋体;font-size:14px;">具备优秀的外联与公关能力，</span><span style="font-family:宋体;font-size:14px;">能够有效的处理</span><span style="font-family:宋体;font-size:14px;">突发事件；</span>
		</p>
	</div>
</div></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=4818&wzlx=employment" class="pres" style="float: left; width: 45%;">上一篇：北京启明星辰信息安全技术有限公司招聘系...</a>
                                
                            

                                    <a href="newshow.aspx?newid=4820&wzlx=employment" class="pres" style="float: right; width: 45%;">下一篇：关于实现创业的毕业年度内高校在校生 办...</a>
