                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]王琼：《中国图书馆学报》——英国高校科研数据保存政策调查与分析</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2016-10-19</span>
                                    点击率：<span id="Label4">105</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="font-family:宋体;font-size:16px;text-align:justify;text-indent:2em;">
	<span style="line-height:1.5;"><span style="font-size:14px;">科研数据保存政策是科研数据共享和再利用的前提条件和基础，日益受到学术界的广泛重视，切实可行的保存政策能保障科研数据的有效管理。本文采用内容分析方法，从保存内容、元数据、格式、位置、期限与销毁、机构与责任、保存要益、安全与隐私八个方面，对英国28所高校的科研数据保存政策进行调研，发现其科研数据保存政策不同保存阶段内容完备程度不同，具有学科差异的数据保存规定仍需进一步细化和完善。我国在制定科研数据保存政策时，应科学设定保存内容和期限，统一规范元数据标准和格式，搭建科研数据保存环境，严格明确数据管理中的责任与权利，完善版权保护和隐私安全政策体系。</span> </span>
</p>
<hr />
<p>
	<br />
...
<p style="font-family:宋体;font-size:16px;text-align:justify;text-indent:2em;">
	<span style="line-height:1.5;font-size:14px;">王琼、曹冉.英国高校科研数据保存政策调查与分析.</span> 
</p>
<p style="font-family:宋体;font-size:16px;text-align:justify;text-indent:2em;">
	<span style="line-height:1.5;font-size:14px;">中国图书馆学报.2016（13）：108-121.</span> 
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=2649&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：黄崑：《图书情报工作》——高校图书馆用...</a>
