                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]王卫：《图书馆理论与实践》——地区公共图书馆Malmquist指数测度及影响因素分析</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-08-28</span>
                                    点击率：<span id="Label4">456</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	公共图书馆效率测度是对公共图书馆投入产出能力的衡量,通过对其测度及影响因素分析可以揭示其运营状况,对提升公共图书馆的管理、服务效能有着重要的意义。文章使用运筹学中的数据包络分析法,对我国地区公共图书馆运营效率进行DEA模型基本测度和Malmquist指数模型测度,并通过回归方法分析影响效率指数的因素。发现在静态测度中我国2011—2013年地区公共图书馆的平均效率较好,但在基于Malmquist指数的动态测度中发现我国地区公共图书馆暴露出技术退步的趋势,全要素生产率(TFP)指数呈下降趋势。在TFP指数影响因素方面,发现投入变量中电子图书对FTP指数呈负向相关关系;外部环境变量中地区生产总值对TFP有正相关关系,平均受教育年限呈负相关。
</p>
<p style="text-indent:2em;">
	王卫、闫帅.地区公共图书馆Malmquist指数测度及影响因素分析[J].图书馆理论与实践, 2017, (01)，79-84.
</p>
<p style="text-indent:2em;">
	<br />
</p>
<p style="text-indent:2em;">
	<br />
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=6989&wzlx=topic" class="pres" style="float: left; width: 45%;">上一篇：王卫：《情报杂志》—基于期刊论文的作者...</a>
