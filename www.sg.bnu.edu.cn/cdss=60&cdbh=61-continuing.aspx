                ...
                <div class="col-md-12 column">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-9 column pn col-sm-10 col-xs-12 ">
                            <div class="url-title">
                                <b>
                                    <span id="ctl00_ContentPlaceHolder1_Label5">继续教育</span></b>
                                <ul class="breadcrumb">
                                    当前位置:
                            <li>
                            ...
                            <div class="ins_right">
                                <div class="row clearfix" style="margin-bottom: 4%">
                                    <div class="ann-bg" style="background: none; margin-top: 0; min-height: 0">
                                                ...
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="newshow.aspx?newid=6982&wzlx=continuing&cdlx=" target="_blank" class="">2017年秋季学期学位申请通知</a>
                                                ...
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="newshow.aspx?newid=4759&wzlx=continuing&cdlx=" target="_blank" class="">2017年夜大学生交费通知</a>
                                                ...
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="newshow.aspx?newid=4758&wzlx=continuing&cdlx=" target="_blank" class="">2017年春季学期申请学位通知</a>
                                                        <span>2017-03-27</span>
                                                    </li>
                                                </ul>
                                                ...
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="newshow.aspx?newid=4757&wzlx=continuing&cdlx=" target="_blank" class="">我院开通“政管夜大”微信号</a>
                                                        <span>2017-03-27</span>
                                                    </li>
                                                </ul>
                                ...
                                <div class="row clearfix" style="margin-top: 5%; display: none;">
                                    <div style="font-size: 18px; text-align: center; padding: 2% 0">分类2</div>
                                    
                                    <a href="sdlist.aspx?cdid=continuing&cdlx=jxjy2" class="btn" style="float: right">more</a>
                                </div>
                                ...
                                <div class="row clearfix" style="margin-top: 5%; display: none;">
                                    <div style="font-size: 18px; text-align: center; padding: 2% 0">分类3</div>
                                    <div class="col-md-6 column">
                                        <img src="images/xiao/student_002.jpg" class="img-responsive" alt="Cinque Terre" title="" />
                                    </div>
                                    
                                    <a href="sdlist.aspx?cdid=continuing&cdlx=jxjy3" class="btn" style="float: right">more</a>
                                </div>
