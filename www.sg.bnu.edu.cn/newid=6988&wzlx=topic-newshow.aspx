	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWAwKB+byODgLs0bLrBgLSwpnTCOQdkdbg3kXFUPpQ7d/i59KlDC2h" />
        ...
        <section>
            <div class="container" style="width: 980px; margin: 0% auto; background-color: #fff; border-radius: 3px">
                <div style="width: 97%; margin: 1% auto; text-align: right">当前位置：<a href="index.aspx">首页</a>-><span id="Label5">热门话题</span>->正文</div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]王卫：《中国远程教育》——基于心流体验的在线学习持续意愿影响因素研究</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-08-28</span>
                                    点击率：<span id="Label4">460</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	近年来,随着互联网的快速渗透在线教育市场得到快速发展,但高辍学率也成为在线学习相关机构不得不重视的问题。本研究基于心流体验理论,探讨在线学习过程中影响心流体验产生的条件因素及其导致的结果因素,从而研究心流体验对在线学习持续意愿的影响。本研究以MOOC平台为例,通过调查问卷的方式获得204份MOOC用户的数据,用Smart
PLS2.0软件对回收数据进行分析,最终得出了心流体验对在线学习持续意愿影响的结构方程模型。结果表明:目标的准确性、及时的反馈以及临场感可以正向、显著影响心流体验,而挑战与技能的平衡对心流体验产生的影响则不显著;心流体验对在线学习者持续学习意愿产生正向的显著影响,用户满意度和积极的态度是心流体验影响学习者持续在线学习意愿的中介因素。最后,本研究从课程设计、学习者以及在线学习平台三个方面提出了对策和建议。
</p>
<p style="text-indent:2em;">
	<br />
</p>
<p style="text-indent:2em;">
	王卫、史锐涵、李晓娜.基于心流体验的在线学习持续意愿影响因素研究[J].中国远程教育, 2017, (05)，17-23+79.
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=6975&wzlx=topic" class="pres" style="float: left; width: 45%;">上一篇：黄国彬：《数字图书馆论坛》——基于re...</a>
                                
                            

                                    <a href="newshow.aspx?newid=8028&wzlx=topic" class="pres" style="float: right; width: 45%;">下一篇：李兴：《人民论坛》——信息泄露给国际政...</a>
