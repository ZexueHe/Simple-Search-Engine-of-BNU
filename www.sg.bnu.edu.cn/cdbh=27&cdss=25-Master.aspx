                        ...
                        <div class="col-md-9 column pn col-sm-10 col-xs-12 ">
                            ...
                            <div class="ins_right">
                                ...
                                <div id="ctl00_ContentPlaceHolder1_rep1" class="row clearfix" style="margin-bottom: 4%;">
                                        ...
                                        <img src="images/rencai/zhuanyejieshao.png" title="" class="img-responsive" alt="Cinque Terre" style="display: inline; width: 40%;" />
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4813&wzlx=Master" target="_blank">国际关系</a>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4812&wzlx=Master" target="_blank">情报学</a>
                                                            <span>2017-04-06</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4811&wzlx=Master" target="_blank">人力资源管理</a>
                                                            <span>2017-04-06</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4810&wzlx=Master" target="_blank">管理科学与工程</a>
                                                            <span>2017-04-06</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4809&wzlx=Master" target="_blank">图书馆学</a>
                                                            <span>2017-04-06</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4808&wzlx=Master" target="_blank">政治学理论</a>
                                                            <span>2017-04-06</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2592&wzlx=Master" target="_blank">行政管理</a>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2591&wzlx=Master" target="_blank">土地资源管理</a>
                                                            <span>2017-04-07</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2590&wzlx=Master" target="_blank">政府经济管理</a>
                                                            <span>2017-04-07</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                    ...
                                    <a href="personnelshow.aspx?lx=Master&zylx=szyjs&cdss=25" class="btn" style="float: right">more</a>
                                </div>
