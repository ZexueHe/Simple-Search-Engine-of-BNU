                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]周小平：《中国行政管理》—协同治理视角下空间规划体系的反思与建构</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-11-06</span>
                                    点击率：<span id="Label4">83</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	中国现行多部门规划并行、自成体系，规划间矛盾冲突的状况严重阻碍了城乡空间资源的合理利用和经济社会的可持续发展。“多规合一”是实现各部门规划有效衔接的重要路径。研究基于协同治理理论，反思了现有规划存在的问题及其原因，提出了“多规合一”思路下的“协同—协作—保障”体系：以理念协同为导向，确定统一的区域战略目标，通过各部门主体的协同，实现空间布局、技术标准、编制期限等规划要素的统一，形成“多规合一”协同治理逻辑模型；按照协同治理逻辑,构建了由国土空间综合规划统领“多规”的空间规划体系,形成“多规合一”的基本架构；进而通过建立法律法规制度、协同工作机制及信息联动平台的保障体系，确保“多规合一”有效实施，实现区域整体性协同发展。
</p>
<p style="text-indent:2em;">
	周小平、赵萌.协同治理视角下空间规划体系的反思与建构[J].中国行政管理, 2017, (10)，10-15.
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=8054&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：汪波：《社会科学战线》—当代中国腐败测...</a>
