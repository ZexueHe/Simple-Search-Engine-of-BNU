...
<div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]王华春：《统计与决策》——土地财政策略互动的经济增长效应检验</span></span>
                            </h3>
	...
	<span><span style="font-size:14px;font-family:SimSun;line-height:1.5;">通过构建五种权重下的空间模型，考察“招拍挂”和协议出让等土地出让行为的策略互动及经济增长效应。研究结果表明：土地出让行为存在竞赛到底的空间策略竞争；土地财政侧重以协议出让为主的引资策略竞争，土地出让面积相比于收入竞争更显著；经济增长在地理和资本流动相邻权重下存在空间互补效应，在人口流动相邻权重下为空间替代效应；土地出让收入刺激土地资源和资本流动相邻省份经济，抑制劳动力流动相邻省份经济。</span> </span>
</p>
<hr />
<p>
	<br />
...
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">王华春、刘清杰.土地财政策略互动的经济增长效应检验.统计与决策.2016（07）：99-103.</span> 
</p>
<p style="text-indent:2em;">
	<br />
</p></span>
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=2552&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：孙宇：《现代西方公共行政思想简史》</a>
