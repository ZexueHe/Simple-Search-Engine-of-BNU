...
<head id="head1"><meta http-equiv="pragma" content="no-cache" /><meta name="”renderer”" content="webkit|ie-comp|ie-stand" /><meta http-equiv="cache-control" content="no-cache" /><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta http-equiv="expires" content="0" /><meta http-equiv="keywords" content="北京师范大学政府管理学院,政府管理学院,北师大政府管理学院,北师大政府管理学院,www.heu.edu.cn" /><meta http-equiv="description" content="欢迎访问北京师范大学政府管理学院" /><meta http-equiv="X-UA-Compatible" content="IE=edge" /><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8" /><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE10" /><meta name="viewport" content="width=device-width, initial-scale=1" /><meta http-equiv="X-UA-Compatible" content="IE=edge,Chrome=1" /><meta http-equiv="X-UA-Compatible" content="IE=9" /><meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0" /><title>
	北京师范大学政府管理学院
</title><link rel="stylesheet" href="css/bootstrap.min.css" /><link rel="stylesheet" href="css/css.css" /><link rel="stylesheet" href="css/style.css" /><link rel="stylesheet" href="fonts/iconfont.css" /><link href="css/jquery-accordion-menu.css" rel="stylesheet" type="text/css" /><link rel="stylesheet" href="css/owl.carousel.css" />
    <!--轮播图-->
                            ...
                            <li>
                                <a href="index.aspx">首页</a>
                                    ...
                                    <li>
                                            ...
                                            <span id="Label3">学生工作</span>
                                    </li>
                                    <li class="active">
                                        <span id="Label4">党旗飘飘</span>
                                    </li>
                                </ul>
                            </div>
                                <!--右边标题路径导航-->
                                ...
                                <div class="ins_right">
                                    <div class="row clearfix" style="margin-bottom: 4%">
                                        <h3 class="stu-title">党员模范</h3>
                                        
                                                <div class="col-md-6 column ke">
                                                    <p class="keyan">
                                                        <img  src="images/46.jpg" title="keyan" class="img-responsive" alt="Cinque Terre" />
                                                    </p>
                                                </div>
                                                <div class="col-md-6 column ke">
                                                    <h3 class="blue">
                                                        <a href="newshow.aspx?newid=4922&wzlx=building&cdlx=dymf" target="_blank" >
                                                            政府管理学院二级党校第二期录取名单公示</a>
                                                    </h3>
                                                    <p>
                                                         	   	经过前期报名与资格测试筛选，政府管理学院二级党校第二期拟录取以下学员，现公示如下：   	    	 		 			 				 					 						序号 					 				 				 					 						院系 					 				 				 					 						姓名 			...
                                                    </p>
                                                    <a href="sdlist.aspx?cdid=building&cdlx=dymf" class="btn" style="float: right">more</a>
                                                </div>
                                    ...
                                    <div class="row clearfix" style="padding: 0 15px">
                                        <!----start-img-cursual---->
                                        <h3 class="stu-title">优秀党员</h3>
                                        
                                        <div id="owl-demo" class="owl-carousel text-center">
                                            
                                            <div class="item">
                                                <div class="cau_left">
                                                    <img class="lazyOwl  img-circle img-responsive" data-src="images/46.jpg" alt="Lazy Owl Image">
                                                </div>
                                                <div class="cau_left">
                                                    <h4><a href="newshow.aspx?newid=4873&wzlx=building&cdlx=yxdy" target="_blank" >许家敏</a></h4>
                                                    <p>
                                                         	坚定信念，砥砺前行   	作为一名党员，许家敏同志能继续认真...
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item">
                                                ...
                                                <div class="cau_left">
                                                    <h4><a href="newshow.aspx?newid=4872&wzlx=building&cdlx=yxdy" target="_blank" >于佳</a></h4>
                                                    <p>
                                                         	 		在思想上，该同志能够不断提高自身党性修养，注重党的基础...
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item">
                                                ...
                                                <div class="cau_left">
                                                    <h4><a href="newshow.aspx?newid=4835&wzlx=building&cdlx=yxdy" target="_blank" >李奕璇</a></h4>
                                                    <p>
                                                         	李奕璇，政府管理学院2014级行政管理专业硕士研究生，现担任...
                                                    </p>
                                                </div>
                                            </div>
                                                 
                                        </div>
                                               <a  href="sdlist.aspx?cdid=building&cdlx=yxdy" class="btn" style="float: right">more</a> 
                                        <!----//End-img-cursual---->

                                    </div>
                                    <div class="row clearfix">
                                        <h3 class="stu-title">党部活动</h3>
                                         
                                        <div class="col-md-4 column ke">
                                            <div style="width: 100%">
                                                <a href="newshow.aspx?newid=3745&wzlx=building&cdlx=dbhd" target="_blank" >
                                                    <img src="/UploadFile/1703170249404220.jpg" title="" style="height:207px;" class="img-responsive" alt="Cinque Terre" />
                                                </a>
                                                <h4><a href="newshow.aspx?newid=3745&wzlx=building&cdlx=dbhd" target="_blank" class="">政府管理学院二级党校开班仪式...</a></h4>
                                                <p style="width: 100%">       11月17日晚8点，政府管理学院二级党校开班仪式暨首场讲座在...</p>
                                        ...
                                        <div class="col-md-4 column ke">
                                            <div style="width: 100%">
                                                <a href="newshow.aspx?newid=3744&wzlx=building&cdlx=dbhd" target="_blank" >
                                                    <img src="/UploadFile/1703220324257725.jpg" title="" style="height:207px;" class="img-responsive" alt="Cinque Terre" />
                                                </a>
                                                <h4><a href="newshow.aspx?newid=3744&wzlx=building&cdlx=dbhd" target="_blank" class="">我院2016年党建工作交流大...</a></h4>
                                                <p style="width: 100%">      2016年10月16日18：00，政府管理学院2016-201...</p>
                                        ...
                                        <div class="col-md-4 column ke">
                                            <div style="width: 100%">
                                                <a href="newshow.aspx?newid=3743&wzlx=building&cdlx=dbhd" target="_blank" >
                                                    <img src="/UploadFile/1703171116192092.jpg" title="" style="height:207px;" class="img-responsive" alt="Cinque Terre" />
                                                </a>
                                                <h4><a href="newshow.aspx?newid=3743&wzlx=building&cdlx=dbhd" target="_blank" class="">我院公管师生支部共建理论学习...</a></h4>
                                                <p style="width: 100%">    2016年11月2日下午，公管教师党支部师生共建理论学习会在主楼A...</p>

                                            </div>
                                        </div>
                                         
                                    </div>
                                    <a  href="sdlist.aspx?cdid=building&cdlx=dbhd" class="btn" style="float: right">more</a> 
                                    <!--/**/-->
                                </div>
                            </div>
                            <!--右边-->
