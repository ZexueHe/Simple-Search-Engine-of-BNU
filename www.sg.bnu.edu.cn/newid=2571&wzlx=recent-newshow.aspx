                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]刘晓娟：《图书情报工作》——知识融合:概念辨析与界说</span></span>
                            </h3>
                            ...
                            <span id="Label3"><p>
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">&nbsp; &nbsp; &nbsp;[目的/意义]知识融合是一个随技术环境和社会环境不断发展变化的概念,并可应用于多个学科领域,然而目前学术领域对知识融合的概念界定还缺少一致的理解,对其进行辨析有利于推动后续研究。</span> 
</p>
<p>
	<span style="font-family:SimSun;font-size:14px;line-height:1.5;">&nbsp; &nbsp; [方法/过程]通过充分调研和分析,在理论和实践层面汲取以往研究中的观点和成果,一方面选取不同时期和不同领域的知识融合概念的典型表述,并分别提取“处理对象”“融合过程”以及“融合结果”3个关键要素；另一方面通过知识融合系统体系架构的剖析来进一步明确知识融合的研究范畴与边界。</span> 
</p>
<p>
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">&nbsp; &nbsp; [结果/结论]综合概括得到一个相对完整的知识融合概念定义,并从流程角度对知识融合概念进行分解。</span> 
</p>
<hr />
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">刘晓娟、李广建、化柏林.知识融合:概念辨析与界说.图书情报工作.</span> 
</p>
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">2016（13）：13-19.</span> 
</p>
<br /></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=2570&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：孙宇：《互联网笔记》</a>
