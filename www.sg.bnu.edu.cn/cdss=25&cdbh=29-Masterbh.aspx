                ...
                <div class="col-md-12 column">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-9 column pn col-sm-10 col-xs-12 ">
                           <div class="url-title">
                                <b>  <span id="ctl00_ContentPlaceHolder1_Label5">博士后</span></b>
                                <ul class="breadcrumb">
                                    当前位置:
                            <li>
                                <a href="index.aspx">首页</a>
                                    ...
                                    <li class="active">
                                        <span id="ctl00_ContentPlaceHolder1_Label4">博士后</span>
                                    </li>
                                </ul>
                            </div>
                            <!--右边标题路径导航-->
                            ...
                            <div class="ins_right">
                             <div id="ctl00_ContentPlaceHolder1_rep1" class="row clearfix" style="margin-bottom: 4%;">
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2416&wzlx=Masterbh" target="_blank">与院系所相关的博士后管理工作流程</a>
                                ...
                                <div id="ctl00_ContentPlaceHolder1_rep2" class="row clearfix" style="margin-bottom: 4%;">
                                    <h3 style="text-align: center;">
                                        <img src="images/rencai/zaizhanguanl.png" title="" class="img-responsive" alt="Cinque Terre" style="display: inline; width: 40%;" />
                                    </h3>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2415&wzlx=Masterbh" target="_blank">博士后常见问题</a>
                                                            <span>2014-03-05</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=2414&wzlx=Masterbh" target="_blank">政府管理学院博士后进站遴选指标</a>
                                                            <span>2014-03-05</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                ...
                                <div id="ctl00_ContentPlaceHolder1_rep3" class="row clearfix" style="margin-bottom: 4%;">
                                    <h3 style="text-align: center;">
                                        <img src="images/rencai/chuzhanguanl.png" title="" class="img-responsive" alt="Cinque Terre" style="display: inline; width: 40%;" />
                                    </h3>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4904&wzlx=Masterbh" target="_blank">政府管理学院博士后出站考核指标</a>
                                            ...
                                            <div class="col-md-6 column">
                                                <div class="ann-bg" style="background: none; margin-top: 0; min-height: inherit">
                                                    <ul class="ann-list regis-list" style="margin: 0; width: 100%">
                                                        <li>
                                                            <a href="newshow.aspx?newid=4863&wzlx=Masterbh" target="_blank">北京师范大学博士后出站须知</a>
