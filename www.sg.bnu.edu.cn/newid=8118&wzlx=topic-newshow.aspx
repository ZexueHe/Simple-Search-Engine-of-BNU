                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]王洛忠：《学习与探索》——新制度主义视野下草根NGO转型的“交叉”模式——基于科学松鼠会的案例研究</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-12-12</span>
                                    点击率：<span id="Label4">107</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	在社会创新大背景下,草根NGO为摆脱滴水经济困境,往往借力市场致力于公益目标,这种组织转型实践已探索数年。"交叉"模式是草根NGO转型的创新突破,是社会企业萌芽的成功试验。以科学松鼠会为案例,探究组织转型中"交叉"模式的效率机制和合法性机制如何相互作用具有重要意义。在新制度主义视野下,其独特性体现为:将政策合法性作为组织转型的逻辑起点,将社会合法性作为组织转型的逻辑终点,而效率机制成为组织转型的一个调节变量。效率机制的有效性主要取决于公益项目本身的市场可行性、组织结构调整的及时科学、真实内部运作与组织结构的分离。
</p>
<p style="text-indent:2em;">
	王洛忠、张艺君.新制度主义视野下草根NGO转型的“交叉”模式——基于科学松鼠会的案例研究[J].学习与探索, 2016, (06)，56-61.
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=8117&wzlx=topic" class="pres" style="float: left; width: 45%;">上一篇：王洛忠：《理论探讨》——福利三角理论视...</a>
                                
                            

                                    <a href="newshow.aspx?newid=8123&wzlx=topic" class="pres" style="float: right; width: 45%;">下一篇：李兴：《人民论坛》—中国外交彰显大国担...</a>
