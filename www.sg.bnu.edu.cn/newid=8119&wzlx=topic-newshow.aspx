                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]王洛忠：《中共中央党校学报》——京津冀雾霾合作治理困境及其解决途径</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-12-12</span>
                                    点击率：<span id="Label4">119</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	区域性环境污染问题日益突出,要求多元行动主体整合信任资源、信息资源和技术资源,强化协同共治的认知与规则,构建跨行政区的合作治理模式。京津冀已经成为全国雾霾污染最严重的地区,大气污染区域合作治理在政府间合作规则与信任关系构建、信息与技术共享等问题上面临多重困境。通过引入政策网络分析工具,可以从行动者、资源、规则和认知等多个维度分析京津冀雾霾治理合作的困境。选择有效的网络管理策略,激活协调者角色,将合作意识转为合作行动;完善政策法规,强化区域合作的制度约束;拓展信息与技术资源共享空间,培养合作型信任,则成为缓解区域合作治理困境的有效途径。
</p>
<p style="text-indent:2em;">
	王洛忠、丁颖.京津冀雾霾合作治理困境及其解决途径[J].中共中央党校学报, 2016, (03)，74-79.
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=8118&wzlx=topic" class="pres" style="float: left; width: 45%;">上一篇：王洛忠：《学习与探索》——新制度主义视...</a>
