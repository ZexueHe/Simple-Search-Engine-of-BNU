                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">中国未来婚姻挤压的时空特征以及对策研究</span></span>
                            </h3>
			...
			<td>
				刘莹、吕俊宇、王君哲
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=4889&wzlx=laboratory" class="pres" style="float: left; width: 45%;">上一篇：转型期政务微博应急管理功能及其有效性影...</a>
                                
                            

                                    <a href="newshow.aspx?newid=4891&wzlx=laboratory" class="pres" style="float: right; width: 45%;">下一篇：Web 2.0环境下学术影响力评价的实...</a>
