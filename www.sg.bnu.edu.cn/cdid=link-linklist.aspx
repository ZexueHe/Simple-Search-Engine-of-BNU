                ...
                <div class="col-md-12 column">
                    <div class="row clearfix">
                        <div class="col-md-3 column  col-sm-2 col-xs-4">
                                 <div class="content">
                                <h3 class="title">
                                    <span id="ctl00_ContentPlaceHolder1_Label4">友情链接</span>
                                </h3>
                                ...
                                <div class="row clearfix" style="margin-bottom: 4%">
                                    <div class="ann-bg" style="background: none; margin-top: 0; min-height: 0">
                                                ...
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="http://cogs.bnu.edu.cn/" target="_blank" class="">跨学科实验室</a>
                                                    </li>
                                                </ul>
                                            
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="http://ccprr.bnu.edu.cn/" target="_blank" class="">北京师范大学中国扶贫研究院</a>
                                                    </li>
                                                </ul>
                                            
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="http://spap.ruc.edu.cn/" target="_blank" class="">中国人民大学公共管理学院</a>
                                                    </li>
                                                </ul>
                                            
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="http://www.sppm.tsinghua.edu.cn/" target="_blank" class="">清华大学公共管理学院</a>
                                                    </li>
                                                </ul>
                                            
                                                <ul class="ann-list regis-list" style="padding: 0 15px 0 15px; margin: 0; width: 100%">
                                                    <li>
                                                        <a href="http://www.mpa.org.cn/" target="_blank" class="">全国MPA教育指导委员会</a>
                                                    </li>
                                                </ul>
