                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]王琼：《图书情报工作》——国外大学数据监护教育的调查与分析</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2016-05-24</span>
                                    点击率：<span id="Label4">41</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">[目的/意义] 深入了解国外大学数据监护教育的发展现状，为我国今后开展数据监护教育提供借鉴。</span> 
</p>
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">[方法/过程]利用网络调研和内容分析方法，对DCC所列举的16所具有代表性数据监护教育院校进行了调研，深入分析培养目标、学位设置和课程设置等，研究了主要的教育模式和教学特点，探讨了我国数据监护教育开展的途径和方法。</span> 
</p>
<p style="text-indent:2em;">
	<span><span style="font-size:14px;font-family:SimSun;line-height:1.5;">[结论/结果]目前国外数据监护教育已经大规模兴起，虽然各院校教学情况存在差异，但已初具规模，并形成了较为明确的教学内容，可为我国今后开展数据监护教育提供借鉴和启示。</span> </span>
</p>
<hr />
<p>
	<br />
...
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">曹冉、王琼、耿骞、刘晓娟.国外大学数据监护教育的调查与分析.图书情报工作.2016（04）.</span> 
</p>
<br /></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=2558&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：黄崑：《图书情报工作》——高校图书馆O...</a>
