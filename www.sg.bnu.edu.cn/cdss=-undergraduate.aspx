                        ...
                        <div class="col-md-9 column pn col-sm-10 col-xs-12 ">
                            ...
                            <div class="ins_right">
                                <div id="ctl00_ContentPlaceHolder1_rep1" class="row clearfix" style="margin-bottom: 4%;">
                                    ...
                                    <a href="personnelshow.aspx?lx=undergraduate&zylx=bzyjs&cdss=" class="btn" style="float: right">more</a>
                                </div>
                                <div id="ctl00_ContentPlaceHolder1_rep2" class="row clearfix" style="margin-bottom: 4%;">
                                    ...
                                    <a href="personnelshow.aspx?lx=undergraduate&zylx=bzsxc&cdss=" class="btn" style="float: right">more</a>
                                </div>
                                <div id="ctl00_ContentPlaceHolder1_rep3" class="row clearfix" style="margin-bottom: 4%;">
                                    ...
                                    <a href="personnelshow.aspx?lx=undergraduate&zylx=bjxjh&cdss=" class="btn" style="float: right">more</a>
                                </div>
                                <div id="ctl00_ContentPlaceHolder1_rep4" class="row clearfix" style="margin-bottom: 4%;">
                                    ...
                                    <a href="personnelshow.aspx?lx=undergraduate&zylx=bjyqx&cdss=" class="btn" style="float: right">more</a>
                                </div>
                            </div>
                        </div>
                        <!--右边-->
