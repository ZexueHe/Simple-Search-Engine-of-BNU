                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">北京幕击影视工作室</span></span>
                            </h3>
			...
			<td>
				董子千、李戎婷、章柳、赖思宇
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=4891&wzlx=laboratory" class="pres" style="float: left; width: 45%;">上一篇：Web 2.0环境下学术影响力评价的实...</a>
                                
                            

                                    <a href="newshow.aspx?newid=4893&wzlx=laboratory" class="pres" style="float: right; width: 45%;">下一篇：让成长伙伴走进万千家庭---DREAM...</a>
