	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWAwL4xpecDQLs0bLrBgLSwpnTCCog+jAiQRjWA6uqO3ESWX251kPt" />
        ...
        <section>
            <div class="container" style="width: 980px; margin: 0% auto; background-color: #fff; border-radius: 3px">
                <div style="width: 97%; margin: 1% auto; text-align: right">当前位置：<a href="index.aspx">首页</a>-><span id="Label5">实验室</span>->正文</div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">本期实验室课题资助对象公布</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2016-09-21</span>
                                    点击率：<span id="Label4">299</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	京师政管创新实验室根据“跨学科、应用性”的项目选拔宗旨，以及对于现有学生项目的进展状况的了解，最终选拔出了4个课题作为本批创新实验室的资助对象，名单如下：
</p>
<p style="text-indent:2em;">
	跨国科研合作中各国贡献量及影响因素探究——以高能物理领域为例（邓思艺）
</p>
<p style="text-indent:2em;">
	基于各省帕累托指数的中国城市规模分布特征分析(熊斯瑶）
</p>
<p style="text-indent:2em;">
	基于关联数据的政府数据发布与利用研究&nbsp;（王 博）&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
</p>
<p style="text-indent:2em;">
	SEED学堂&nbsp;（石 锐）&nbsp;
</p></span>
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=4876&wzlx=laboratory" class="pres" style="float: left; width: 45%;">上一篇：实验室公告</a>
                                
                            

                                    <a href="newshow.aspx?newid=4878&wzlx=laboratory" class="pres" style="float: right; width: 45%;">下一篇：实验室预约及设备使用公告</a>
