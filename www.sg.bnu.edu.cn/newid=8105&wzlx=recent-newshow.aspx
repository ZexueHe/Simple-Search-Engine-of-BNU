                        ...
                        <div class="kec_s ">   
                            ...
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-12-07</span>
                                    点击率：<span id="Label4">125</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	[目的/意义]针对法律文献资源,设计一个统一的关联框架,以提高法律文献关联数据的质量。[方法/过程]以我国法律文献的制定、修改和发布实践为基础,设计FRBR模型在法律文献上的具体应用方式。对法律文献资源进行分层描述,精确表达版本信息、格式信息;同时依据法律文献结构,对其细化切分,细化关联资源粒度;在此基础上设计URL规范和描述本体。[结果/结论]试验验证表明:基于该关联框架构建的法律文献关联数据集,结构有序,关系清晰,资源粒度精细,对其执行SPARQL检索,能提供更快速、准确的检索结果,能更好地满足用户的信息需求。
</p>
<p style="text-indent:2em;">
	邢启迪、耿骞、赵盼云、景然.法律文献资源关联模型设计与应用研究[J].图书情报工作, 2017, (10)，131-140.
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=8099&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：连宏萍：《土地制度比较》</a>
                                
                            

                                    <a href="newshow.aspx?newid=8113&wzlx=recent" class="pres" style="float: right; width: 45%;">下一篇：王华春：《北京师范大学学报（社会科学版...</a>
