                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]周晓燕：《图书情报知识》——澳大利亚高校科研数据保存政策分析</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2016-05-27</span>
                                    点击率：<span id="Label4">46</span>
                                </span>
                            </h5>
                            <span id="Label3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size:14px;font-family:SimSun;line-height:1.5;">澳大利亚高校的科研数据管理政策制定较早、政策体系发展也较为成熟,本文通过文献调研法和内容分析法对22所澳大利亚高校的科研数据管理政策中的科研数据保存政策进行了专门和深入的调研和分析,从科研数据保存的各个环节,即科研数据保存前的数据处理、数据保存期限、保存位置、保存位置的变更、保存格式、数据备份和超过保存期限的数据销毁7个方面,全面深入地调研和分析了澳大利亚高校科研数据管理政策中的科研数据保存政策,希望对科研数据服务尚在起步阶段的中国高校提供政策借鉴。</span> 
<hr />
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">周晓燕、宰冰欣.澳大利亚高校科研数据保存政策分析.图书情报知识.2016（02）.122-128</span> 
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=2561&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：周晓燕：《图书情报工作》——国外高校图...</a>
