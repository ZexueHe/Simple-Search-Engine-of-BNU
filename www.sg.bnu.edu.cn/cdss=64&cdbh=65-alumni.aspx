                ...
                <div class="col-md-12 column">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-9 column pn col-sm-10 col-xs-12 ">
                              <div class="url-title">
                                <b>
                                    <span id="ctl00_ContentPlaceHolder1_Label5">院友活动</span></b>
                                <ul class="breadcrumb">
                                    当前位置:
                            <li>
                                <a href="index.aspx">首页</a>
                                    ...
                                    <li class="active">
                                        <span id="ctl00_ContentPlaceHolder1_Label4">院友活动</span>
                                    </li>
                                </ul>
                            </div>
                            <!--右边标题路径导航-->
                            ...
                            <div class="ins_right">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div id="portfolio" class="pfblock">
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4">
                                                    <div class="grid wow zoomIn">
                                                        <a href="newshow.aspx?newid=8021&wzlx=alumni" target="_blank">
                                                            <figure class="effect-bubba">
                                                                <img src="/UploadFile/1709260449307282.jpg" class="img-responsive" alt="Cinque Terre" />
                                                                <figcaption>
                                                                    <h2>03级人力资源管...</h2>
                                                                    <p> 	2017年9月16日，政府管理学院03...</p>
                                                                </figcaption>
                                                            </figure>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4">
                                                    <div class="grid wow zoomIn">
                                                        <a href="newshow.aspx?newid=8020&wzlx=alumni" target="_blank">
                                                            <figure class="effect-bubba">
                                                                <img src="/UploadFile/1709260442166210.jpg" class="img-responsive" alt="Cinque Terre" />
                                                                <figcaption>
                                                                    <h2>07级信息管理专...</h2>
                                                                    <p> 	2017年9月9日，政府管理学院07级...</p>
                                                                </figcaption>
                                                            </figure>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4">
                                                    <div class="grid wow zoomIn">
                                                        <a href="newshow.aspx?newid=6971&wzlx=alumni" target="_blank">
                                                            <figure class="effect-bubba">
                                                                <img src="images/46.jpg" class="img-responsive" alt="Cinque Terre" />
                                                                <figcaption>
                                                                    <h2>政府管理学院20...</h2>
                                                                    <p> 	   	    	   	    	 ...</p>
                                                                </figcaption>
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4">
                                                    <div class="grid wow zoomIn">
                                                        <a href="newshow.aspx?newid=1120&wzlx=alumni" target="_blank">
                                                            <figure class="effect-bubba">
                                                                <img src="images/46.jpg" class="img-responsive" alt="Cinque Terre" />
                                                                <figcaption>
                                                                    <h2>我院成功举办20...</h2>
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4">
                                                    <div class="grid wow zoomIn">
                                                        <a href="newshow.aspx?newid=1119&wzlx=alumni" target="_blank">
                                                            <figure class="effect-bubba">
                                                                <img src="images/46.jpg" class="img-responsive" alt="Cinque Terre" />
                                                                <figcaption>
                                                                    <h2>我院成功举办20...</h2>
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4">
                                                    <div class="grid wow zoomIn">
                                                        <a href="newshow.aspx?newid=1118&wzlx=alumni" target="_blank">
                                                            <figure class="effect-bubba">
                                                                <img src="images/46.jpg" class="img-responsive" alt="Cinque Terre" />
                                                                <figcaption>
                                                                    <h2>北京高校MPA羽...</h2>
                                    ...
                                    <a href="sddlist.aspx?cdid=alumni" class="btn" style="float: right">more</a>
                                </div>
                                <!-- Portfolio end -->
