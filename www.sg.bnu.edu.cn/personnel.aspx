                    ...
                    <ul class="subChannelList multiChannel">
                        <li>
                            <figure>
                                ...
                                <figcaption>
                                    <h3><a href="undergraduate.aspx?cdss=" id="ctl00_ContentPlaceHolder1_benke">本科生</a></h3>
                                </figcaption>
                                <ul class="clearfix">
                                    <li><a href="undergraduate.aspx?zylx=bzyjs&cdss=" id="ctl00_ContentPlaceHolder1_benke1"><i class="icon-angle-right"></i>专业介绍</a></li>
                                    <li><a href="undergraduate.aspx?zylx=bzsxc&cdss=" id="ctl00_ContentPlaceHolder1_benke2"><i class="icon-angle-right"></i>招生宣传</a></li>
                                    <li><a href="undergraduate.aspx?zylx=bjxjh&cdss=" id="ctl00_ContentPlaceHolder1_benke3"><i class="icon-angle-right"></i>培养方案</a></li>
                                    <li><a href="undergraduate.aspx?zylx=bjyqx&cdss=" id="ctl00_ContentPlaceHolder1_benke4"><i class="icon-angle-right"></i>就业去向</a></li>
                    ...
                    <ul class="subChannelList multiChannel">
                        <li>
                            <figure>
                                ...
                                <figcaption>
                                    <h3><a href="Masterbh.aspx?cdss=" id="ctl00_ContentPlaceHolder1_boshih">博士后</a></h3>
                                </figcaption>
                                <ul class="clearfix">
                                    <li><a href="Masterbh.aspx?zylx=mhpyfa&cdss=" id="ctl00_ContentPlaceHolder1_boshih1"><i class="icon-angle-right"></i>培养方案</a></li>
                                    <li><a href="Masterbh.aspx?zylx=mhzzgl&cdss=" id="ctl00_ContentPlaceHolder1_boshih2"><i class="icon-angle-right"></i>在站管理</a></li>
                                    <li><a href="Masterbh.aspx?zylx=mhjyqx&cdss=" id="ctl00_ContentPlaceHolder1_boshih3"><i class="icon-angle-right"></i>出站管理</a></li>
                                </ul>
                            </figure>
                        </li>
                    </ul>
                    ...
                    <ul class="subChannelList multiChannel">
                        <li>
                            <figure>
                                ...
                                <figcaption>
                                    <h3><a href="Master.aspx?cdss=" id="ctl00_ContentPlaceHolder1_suoshi">硕士生</a></h3>
                                </figcaption>
                                <ul class="clearfix">
                                    <li><a href="Master.aspx?zylx=szyjs&cdss=" id="ctl00_ContentPlaceHolder1_suoshi1"><i class="icon-angle-right"></i>专业介绍</a></li>
                                    <li><a href="Master.aspx?zylx=spyfx&cdss=" id="ctl00_ContentPlaceHolder1_suoshi2"><i class="icon-angle-right"></i>培养方案</a></li>
                    ...
                    <ul class="subChannelList multiChannel">
                        <li>
                            <figure>
                                ...
                                <figcaption>
                                    <h3><a href="index-mpa.aspx?cdss=" id="ctl00_ContentPlaceHolder1_mpa">MPA</a></h3>
                                </figcaption>
                                <ul class="clearfix">
                                    <li><a href="index-mpa.aspx?zylx=mpags&cdss=" id="ctl00_ContentPlaceHolder1_mpa1"><i class="icon-angle-right"></i>MPA概述</a></li>
                                    <li><a href="index-mpa.aspx?zylx=mpazsypy&cdss=" id="ctl00_ContentPlaceHolder1_mpa2"><i class="icon-angle-right"></i>招生与培养</a></li>
                                    <li><a href="index-mpa.aspx?zylx=mpaszll&cdss=" id="ctl00_ContentPlaceHolder1_mpa3"><i class="icon-angle-right"></i>师资力量</a></li>
                                    <li><a href="index-mpa.aspx?zylx=mpahuodong&cdss=" id="ctl00_ContentPlaceHolder1_mpa4"><i class="icon-angle-right"></i>MPA活动</a></li>
                                </ul>
                            </figure>
                        </li>
                    </ul>
                    ...
                    <ul class="subChannelList multiChannel">
                        <li>
                            <figure>
                                ...
                                <figcaption>
                                    <h3><a href="Masterb.aspx?cdss=" id="ctl00_ContentPlaceHolder1_boshi">博士生</a></h3>
                                </figcaption>
                                <ul class="clearfix">
                                    <li><a href="Masterb.aspx?zylx=mzyjs&cdss=" id="ctl00_ContentPlaceHolder1_boshi1"><i class="icon-angle-right"></i>专业介绍</a></li>
                                    <li><a href="Masterb.aspx?zylx=mpyfa&cdss=" id="ctl00_ContentPlaceHolder1_boshi2"><i class="icon-angle-right"></i>培养方案</a></li>
                    ...
                    <ul class="subChannelList multiChannel">
                        <li>
                            <figure>
                                ...
                                <figcaption>
                                    <h3><a href="laboratory.aspx?cdss=" id="ctl00_ContentPlaceHolder1_shiyanshi">实验室</a></h3>
                                </figcaption>
                                <ul class="clearfix">
                                    <li><a href="laboratory.aspx?zylx=labgk&cdss=" id="ctl00_ContentPlaceHolder1_shiyanshi1"><i class="icon-angle-right"></i>概况</a></li>
                                    <li><a href="laboratory.aspx?zylx=labgg&cdss=" id="ctl00_ContentPlaceHolder1_shiyanshi2"><i class="icon-angle-right"></i>公告</a></li>
                                    <li><a href="laboratory.aspx?zylx=labxw&cdss=" id="ctl00_ContentPlaceHolder1_shiyanshi3"><i class="icon-angle-right"></i>新闻</a></li>
                                    <li><a href="laboratory.aspx?zylx=labxm&cdss=" id="ctl00_ContentPlaceHolder1_shiyanshi4"><i class="icon-angle-right"></i>项目</a></li>
                                </ul>
                            </figure>
                        </li>
                    </ul>
