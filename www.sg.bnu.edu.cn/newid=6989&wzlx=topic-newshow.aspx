                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]王卫：《情报杂志》—基于期刊论文的作者学术合作与科研产出关系研究—以图书情报领域为例</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-08-28</span>
                                    点击率：<span id="Label4">448</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	[目的/意义]随着科学研究范围的扩展和研究程度的深入,学术合作逐渐成为主流的科学研究方式。如何量化作者间的学术合作和科研产出水平、探究合作与产出间的关系对于了解科研实践中学术合作的情况与特点、开展学术评价、制定科研管理政策以及促进科学发展等方面有重要意义。[方法/过程]以图书情报领域的521位作者为研究对象,对学术合作和科研产出水平进行量化,用SPSS对收集到的数据进行相关分析和差异性分析。[结果/结论]分别构建了学术合作和科研产出的指标体系,得出该体系下的合作指标与产出指标间存在较多相关性,且不同合作/产出水平下,作者科研产出/学术合作分布存在差异;合作能力指数是测度学术合作一个较为特殊、全面的指标,科研人员在其科研活动中应加强学术合作并注重建立起较为稳定的合作模式。
</p>
<p style="text-indent:2em;">
	<br />
</p>
<p style="text-indent:2em;">
	王卫、史锐涵、潘京华.基于期刊论文的作者学术合作与科研产出关系研究—以图书情报领域为例[J].情报杂志, 2017, (03)，191-195.
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=6988&wzlx=topic" class="pres" style="float: left; width: 45%;">上一篇：王卫：《中国远程教育》——基于心流体验...</a>
