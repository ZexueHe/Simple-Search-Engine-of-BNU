                ...
                <div class="col-md-12 column">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-9 column pn col-sm-10 col-xs-12 ">
                            <div class="url-title">
                                <b>
                                    <span id="ctl00_ContentPlaceHolder1_Label5">班级建设</span></b>
                                <ul class="breadcrumb">
                                    当前位置:
                            <li>
                                <a href="index.aspx">首页</a>
                                    ...
                                    <li class="active">
                                        <span id="ctl00_ContentPlaceHolder1_Label4">班级建设</span>
                                    </li>
                                </ul>
                            </div>
                            <!--右边标题路径导航-->
                            ...
                            <div class="ins_right">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div id="portfolio" class="pfblock">
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4">
                                                    <div class="grid wow zoomIn">  <a href="newshow.aspx?newid=2612&wzlx=studentactivity" target="_blank"> 
                                                        <figure class="effect-bubba">
                                                          <img src="/UploadFile/1611290201153378.jpg" class="img-responsive" alt="Cinque Terre" />
                                                            <figcaption>
                                                                <h2>世界因不同而精彩...</h2>
                                                                <p>    10月24日晚六点，在我院张胜军老...</p>
                                                            </figcaption>
                                                        </figure></a>
                                                    </div>
                                                </div>
                                 ...
                                 <a href="sddlist.aspx?cdid=studentactivity" class="btn" style="float: right">more</a>
                                <!-- Portfolio end -->
