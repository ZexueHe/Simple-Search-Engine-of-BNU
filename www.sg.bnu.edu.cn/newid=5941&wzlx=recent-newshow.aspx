                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]王琼：《大学图书馆学报》——数据监护人才需求驱动的教育教学变革研究</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-05-18</span>
                                    点击率：<span id="Label4">318</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	在社会信息化和大数据发展背景下,数据监护人才需求日益提高,数据监护教育的开展势在必行。作者利用网络调研、文献调研和内容分析法,从社会背景、行业需求和技能要求三方面对数据监护人才需求进行分析,并对国外数据监护教育教学变革实践进行剖析和对比。结果认为:国内外数据监护人才需求已经明确,国外数据监护教育教学体系已趋于稳定,并从依托情报学专业课程形成数据监护课程内容、以硕士学位教育和认证教育为主要培养层次、充分利用合作培养方式、针对不同培养对象采用不同教学形式、组建优秀教师队伍并加强培训工作等方面,为我国今后开展数据监护教育提出建议。
</p>
<p style="text-indent:2em;">
	曹冉、王琼、耿骞、凌翥.数据监护人才需求驱动的教育教学变革研究[J].大学图书馆学报, 2017, (02)，81-87.
</p>
<p style="text-indent:2em;">
	<br />
</p>
<p style="text-indent:2em;">
	<br />
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=4944&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：王磊：《China Quarterly...</a>
