                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">“机器学习在智能图像处理及精准医学中的应用“讲座成功举办</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-07-06</span>
                                    点击率：<span id="Label4">308</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-align:center;text-indent:2em;">
	<img src="/kindeditor/attached/image/20170706/20170706144628_1390.jpg" alt="" width="537" height="403" title="" align="" />
</p>
<p style="text-indent:2em;">
	2017年7月5日下午，政府管理学院邀请美国威斯康辛大学密尔沃基分校兼职教授吴义熔老师在主楼A509会议室为我院师生带来“Applications of machine learning in intelligent image processing
and precision medicine（机器学习在智能图像处理及精准医学中的应用）”专题讲座。
</p>
<p style="text-indent:2em;">
	吴义熔老师介绍了通过在基因、环境中考虑个体差异性来优化疾病治疗以及预测有效性的相关方法和过程，以及如何通过建立强大的临床数据库，包括临床基因组学知识库、个人基因组学、电子健康记录以及风险评估方法，对疾病风险进行评估。在最后的提问环节，吴义熔老师就预测过程中应用的lasso模型以及精密医学在医学领域的应用情况等问题进行了深入交流。
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=6965&wzlx=newslist" class="pres" style="float: left; width: 45%;">上一篇：我院师生参加“一带一路”倡议背景下中国...</a>
