                ...
                <div class="col-md-12 column">
                    <div class="row clearfix">
                        <div class="col-md-3 column  col-sm-2 col-xs-4">
                           <div class="content">
                                <h3 class="title">
                                    <span id="ctl00_ContentPlaceHolder1_Label2">院友之窗</span>
                                </h3>
                                <div id="jquery-accordion-menu" class="jquery-accordion-menu red">
                                    <ul id="demo-list">
                                        
                                                <li id='a65'><a href="alumni.aspx?cdss=64&cdbh=65">院友活动</a></li>
                                            
                                                <li id='a66'><a href="alumnistyle.aspx?cdss=64&cdbh=66">院友风采</a></li>
                                            
                                                <li id='a67'><a href="alumniservice.aspx?cdss=64&cdbh=67">院友服务</a></li>
                        ...
                        <div class="col-md-9 column pn col-sm-10 col-xs-12 ">
                           <div class="url-title">
                                <b>
                                    <span id="ctl00_ContentPlaceHolder1_Label5">院友服务</span></b>
                                <ul class="breadcrumb">
                                    当前位置:
                            <li>
                                <a href="index.aspx">首页</a>
                                    ...
                                    <li>
                                            ...
                                            <span id="ctl00_ContentPlaceHolder1_Label3">院友之窗</span>
                                    </li>
                                    <li class="active">
                                        <span id="ctl00_ContentPlaceHolder1_Label4">院友服务</span>
                                    </li>
                                </ul>
                            </div>
                            <!--右边标题路径导航-->
                                    ...
                                    <div class="ins_right">
                                        ...
                                        <ul class="">
                                            <li>
                                                <!--<span class="label label-default ji">急</span>-->
                                                <a href="newshow.aspx?newid=4831&wzlx=alumniservice" target="_blank">
                                                    <span class="glyphicon glyphicon-plus"></span>
                                                    “同叙情谊，共图发展”——我院举办首届MPA校友返校日活动  
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="">
                                            <li>
                                                <!--<span class="label label-default ji">急</span>-->
                                                <a href="newshow.aspx?newid=4830&wzlx=alumniservice" target="_blank">
                                                    <span class="glyphicon glyphicon-plus"></span>
                                                    “新常态下的双创战略”校友论坛举办  
                                                </a>
                                            </li>
                                        ...
                                        <ul class="">
                                            <li>
                                                <!--<span class="label label-default ji">急</span>-->
                                                <a href="newshow.aspx?newid=4829&wzlx=alumniservice" target="_blank">
                                                    <span class="glyphicon glyphicon-plus"></span>
                                                    我院召开2016年珠海交换生欢迎会  
                                                </a>
                                            </li>
                                        ...
                                        <ul class="">
                                            <li>
                                                <!--<span class="label label-default ji">急</span>-->
                                                <a href="newshow.aspx?newid=4828&wzlx=alumniservice" target="_blank">
                                                    <span class="glyphicon glyphicon-plus"></span>
                                                    北京师范大学校友总会政府管理学院校友分会成立大会顺利举行  
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="">
                                            <li>
                                                <!--<span class="label label-default ji">急</span>-->
                                                <a href="newshow.aspx?newid=4827&wzlx=alumniservice" target="_blank">
                                                    <span class="glyphicon glyphicon-plus"></span>
                                                    国际关系专业校友会举办校友返校暨教师节庆祝活动  
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="">
                                            <li>
                                                <!--<span class="label label-default ji">急</span>-->
                                                <a href="newshow.aspx?newid=4804&wzlx=alumniservice" target="_blank">
                                                    <span class="glyphicon glyphicon-plus"></span>
                                                    北京师范大学校友会第六届理事会第五次会议暨助力母校“双一流”建设论坛举行  
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="">
                                            <li>
                                                <!--<span class="label label-default ji">急</span>-->
                                                <a href="newshow.aspx?newid=4803&wzlx=alumniservice" target="_blank">
                                                    <span class="glyphicon glyphicon-plus"></span>
                                                    二十年再回首——我院92级信息管理系校友返校聚会  
                                                </a>
                                            </li>
                                        </ul>
