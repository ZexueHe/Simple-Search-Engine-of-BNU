                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]黄国彬：《数字图书馆论坛》——基于re3data的英国科学数据发布平台研究</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-07-10</span>
                                    点击率：<span id="Label4">855</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	本文以re3data为数据获取源，选取英国247个科学数据发布平台为研究对象，从责任主体、平台功能、数据资源、数据传输四个角度出发，对英国科学数据发布平台特点进行研究，总结英国科学数据发布平台特点及建设经验，为科研人员访问和利用现有科学数据发布平台、科学数据发布平台建设者建设和完善平台提供一定指导。
</p>
<p style="text-indent:2em;">
	张莎莎、黄国彬、耿骞.基于re3data的英国科学数据发布平台研究[EB/OL].数字图书馆论坛, 2017(6)，16-24.
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=6974&wzlx=topic" class="pres" style="float: left; width: 45%;">上一篇：耿骞：《数字图书馆论坛》——科学数据引...</a>
