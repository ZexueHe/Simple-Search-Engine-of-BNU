                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]汪波：《国家行政学院学报》——中国省部级反腐实证探析</span></span>
                            </h3>
                            ...
                            <span id="Label3">&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:16px;">&nbsp; <span style="font-size:14px;font-family:SimSun;line-height:1.5;">&nbsp;十八大以来持续高压的反腐倡廉初步展现了中国政治生活的"新常态"。基于案例库的数据统计,三个核心指标"省部级腐败官员查处数量的变迁""涉案金额规模变迁""腐败获刑期变化"展示了当代中国省部级反腐规模与趋向。从根源来看,权力-人格化权威-资本的三元交融为省部级官员权力寻租提供了经济空间。从制度异化来看,委托代理链条过长、信息垄断、公民监督的搭便车、政策规避导致横向与纵向维度的双重委托代理失灵。从腐败集团化趋向来看,省部级腐败集团构成"核、点、线、网、体"五要素支撑的"分利联盟",基于其所控制的政治、经济与信息资源,垄断着委托代理链条的信息传递的速率与内容,从而进一步降低了团体腐败的风险与成本。</span> 
<hr />
</span> 
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">&nbsp; 汪波.中国省部级反腐实证探析.</span> 
</p>
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">&nbsp; 国家行政学院学报.2016（04）：92-97.</span> 
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=2574&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：程惠霞：《危机管理——从应急迈向前置》</a>
