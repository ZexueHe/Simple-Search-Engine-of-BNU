                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">反腐败有效性：中央巡视组与明朝巡按比较研究</span></span>
                            </h3>
			...
			<td>
				杨璐、王燕、杨森
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=4887&wzlx=laboratory" class="pres" style="float: left; width: 45%;">上一篇：创客空间人才集聚的影响因素及驱动机制研...</a>
                                
                            

                                    <a href="newshow.aspx?newid=4889&wzlx=laboratory" class="pres" style="float: right; width: 45%;">下一篇：转型期政务微博应急管理功能及其有效性影...</a>
