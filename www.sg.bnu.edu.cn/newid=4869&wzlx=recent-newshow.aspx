                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[著作]肖明：《网络计量学》</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-04-11</span>
                                    点击率：<span id="Label4">267</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	网络计量学是在文献计量学、社会网络分析、网络科学等相关学科的基础上发展起来的一门重要的新兴学科，也是当前国际学术界最活跃的研究领域之一。本书从理论、方法、专题三个层面构建了网络计量学的内容体系，全面、系统地论述了网络计量学的理论基础、经典规律、分析方法、工具软件、专题研究等内容。本书可作为高等院校信息管理与信息系统、信息资源管理、图书馆学、情报学、档案学、出版发行学、科学学、科技管理等专业的网络计量学及相关课程的教材，也可作为广大信息工作者、图书情报与档案工作人员、科研人员、评价人员以及管理人员的业务参考书。为方便学生自学，本书增设了学习目标和课后思考题；为方便老师教学，本书免费配备了电子教案。
</p>
<p style="text-indent:2em;">
	肖明.网络计量学[M].北京师范大学出版社, 2016, 12.
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=4844&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：董藩：《改革》——房贷利息抵个税”方案...</a>
                                
                            

                                    <a href="newshow.aspx?newid=4870&wzlx=recent" class="pres" style="float: right; width: 45%;">下一篇：肖明：《国内图书情报知识图谱实证研究》</a>
