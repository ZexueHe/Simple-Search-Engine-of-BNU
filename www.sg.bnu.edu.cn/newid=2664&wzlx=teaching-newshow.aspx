                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">我院耿骞老师获北京师范大学教学名师奖</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2014-07-27</span>
                                    点击率：<span id="Label4">145</span>
                                </span>
                            </h5>
                            <span id="Label3"><div id="newsdetail">
	<p style="text-indent:2em;">
		<span style="line-height:1.5;font-family:SimSun;font-size:14px;">据教务处消息，经教师申报、部院系推荐、专家评审和校内公示，2014年北京师范大学教学名师奖评选工作结束。其中我院耿骞老师获奖。</span> 
	</p>
	<p style="text-indent:2em;">
		<span style="line-height:1.5;font-family:SimSun;font-size:14px;">2014年北京师范大学教学名师奖获奖教师名单（按姓氏拼音排序）</span> 
	</p>
	<p style="text-indent:2em;">
		<span style="line-height:1.5;font-family:SimSun;font-size:14px;">陈英和（心理学院） 耿 骞（政府管理学院）</span> 
	</p>
	<p style="text-indent:2em;">
		<span style="line-height:1.5;font-family:SimSun;font-size:14px;">黄海洋（数学科学学院） 刘文彪（物理学系）</span> 
	</p>
	<p style="text-indent:2em;">
		<span style="line-height:1.5;font-family:SimSun;font-size:14px;">倪文东（艺术与传媒学院） 王志松（外国语言文学学院）</span> 
	</p>
	<p style="text-indent:2em;">
		<span style="line-height:1.5;font-family:SimSun;font-size:14px;">曾文艺（信息科学与技术学院） 张清华（文学院）</span> 
	</p>
	<p style="text-indent:2em;">
		<span style="line-height:1.5;font-family:SimSun;font-size:14px;">张雁云（生命科学学院） 朱红文（哲学与社会学学院）&nbsp;</span> 
	</p>
</div></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=2663&wzlx=teaching" class="pres" style="float: left; width: 45%;">上一篇：我院获国家级“本科生科研训练与创新创业...</a>
