...
<div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]黄崑：《图书情报工作》——高校图书馆用户OPAC检索失败应对方式及启示</span></span>
                            </h3>
	...
	<span style="line-height:1.5;font-size:14px;">[目的/意义]探讨高校用户使用图书馆OPAC系统遭遇检索失败时提问调整的对应方式。[方法/过程]以北京师范大学图书馆为例，收集并对OPAC日志数据进行编码，分析用户采取停止检索、平移、泛化、专指及混合方式调整应对失败的情况。</span> 
</p>
<p style="font-family:宋体;font-size:16px;text-align:justify;text-indent:2em;">
	<span style="line-height:1.5;"><span style="font-size:14px;">[结果/结论]仅有十分之一的调整不做任何努力直接停止检索；在进行应对的情况中，平移调整最为常见（占44.2%），其次是泛化调整（占24.4%），专指与混合调整的情况比较少见。最后，从用户检索技巧培训和系统改进方面突出对策和建议。</span> </span>
</p>
<hr />
<p>
	<br />
...
<p style="font-family:宋体;font-size:16px;text-align:justify;text-indent:2em;">
	<span style="line-height:1.5;font-size:14px;">王凯飞、黄崑、陈佳琦、吴英梅.高校图书馆用户OPAC检索失败应对方式及启示.</span> 
</p>
<p style="font-family:宋体;font-size:16px;text-align:justify;text-indent:2em;">
	<span style="line-height:1.5;font-size:14px;">图书情报工作.2016（13）：91-99.</span> 
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=2583&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：陈翀：《图书情报工作》——书评众包的用...</a>
