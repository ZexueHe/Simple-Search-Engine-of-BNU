...
<div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]黄崑：《图书情报工作》——高校图书馆OPAC检索失败提问分析及对策研究</span></span>
                            </h3>
	...
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">[目的/意义]探讨用户在公共检索计算机上进行OPAC检索时遭遇失败的原因,为增加用户对系统的使用体验提供对策和建议。</span> 
</p>
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">[方法/过程]以国内某大学图书馆OPAC日志数据为例,从数据资源相关、用户相关、系统功能相关3个角度进行编码和分析。</span> 
</p>
<p style="text-indent:2em;">
	<span><span style="font-size:14px;font-family:SimSun;line-height:1.5;">[结果/结论]总结出三大类、19个具体类目的失败原因:首先,用户相关原因为主要原因,主要体现在用户检索策略方面的欠缺</span> </span>
</p>
<hr />
<p>
	<br />
...
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">黄崑、王凯飞、吴英梅、郭建峰.高校图书馆OPAC检索失败提问分析及对策研究.图书情报工作.2016（07）：123-132.</span> 
</p>
<br /></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=2557&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：章文光：《中国少数民族特色村寨—走进西...</a>
