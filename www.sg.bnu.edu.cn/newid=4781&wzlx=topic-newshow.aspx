                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]周晓燕：《情报科学》——基于国内市场需求的大数据管理人才知识结构分析</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2017-03-29</span>
                                    点击率：<span id="Label4">838</span>
                                </span>
                            </h5>
                            <span id="Label3"><p style="text-indent:2em;">
	【目的/意义】更好地满足大数据管理人才的国内市场需求。【方法/过程】选取了前程无忧网数据管理人才的招聘信息,调研了社会对数据管理人员的知识结构和技能的最真实需求和要求,从而分析大数据环境下数据管理人才的知识结构和岗位职责;再运用网络调查法和内容分析法,对应聘者的信息从人才市场对他们的需求类型、知识背景、综合素质能力、专业知识和特殊技能五个角度出发,深度解析了大数据环境下国内数据管理人才的知识结构。【结果/结论】研究发现,国内大数据环境下数据管理需要具有较强的数据分析能力和计算机技术能力,其中统计分析能力和计算机操作能力是大数据人才的核心竞争力,工作经验会在招聘过程中成为应聘者的优势条件。
</p>
<p style="text-indent:2em;">
	周晓燕、尹亚丽.基于国内市场需求的大数据管理人才知识结构分析[J].情报科学, 2017, (01)，29-34.
</p>
<p style="text-indent:2em;">
	<br />
</p></span>
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=4780&wzlx=topic" class="pres" style="float: left; width: 45%;">上一篇：孙宇：《情报杂志》——1994-201...</a>
