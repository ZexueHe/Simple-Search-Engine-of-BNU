                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">实验室预约及设备使用公告</span></span>
                            </h3>
                            ...
                            <span id="Label3">实验室预约及使用流程已规范化，并将不断改进。掌握实验室使用技能，请下载以下文件：《实验室管理条例》
<p>
	&nbsp; &nbsp;见于左下角“附件下载”
</p>
<p>
	<a id="download" href="http://cogs.bnu.edu.cn/index.php?action=download&amp;entity=article_news&amp;id=35&amp;name=实验室预约及设备使用公告.pdf" target="_blank">【附件下载】</a> 
</p></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                            
                                    <a href="newshow.aspx?newid=4877&wzlx=laboratory" class="pres" style="float: left; width: 45%;">上一篇：本期实验室课题资助对象公布</a>
                                
                            

                                    <a href="newshow.aspx?newid=4879&wzlx=laboratory" class="pres" style="float: right; width: 45%;">下一篇：实验室第二批立项课题</a>
