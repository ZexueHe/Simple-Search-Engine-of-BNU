                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">少数民族地区社会建设和社会管理模式探究--基于四川省北川羌族自治县居民社会认同度的典型调查</span></span>
                            </h3>
                            <h5 class="program_title" style="color: #999; padding-bottom: 2%;">
                                <span style="text-align: center; display: block;">
                                    <span id="Label2">2015-04-01</span>
                                    点击率：<span id="Label4">264</span>
                                </span>
                            </h5>
                            <span id="Label3"><table class="table table-bordered" style="width:800px;margin:10px auto;">
	<tbody>
		<tr>
			<th>
				中文名称
			...
			<td>
				少数民族地区社会建设和社会管理模式探究--基于四川省北川羌族自治县居民社会认同度的典型调查
			</td>
		</tr>
		<tr>
			<th>
			...
			<td>
				一等奖
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=4884&wzlx=laboratory" class="pres" style="float: left; width: 45%;">上一篇：搜易科技商业计划书</a>
                                
                            

                                    <a href="newshow.aspx?newid=4886&wzlx=laboratory" class="pres" style="float: right; width: 45%;">下一篇：外来NGO参与社区社会组织培育的一种探...</a>
