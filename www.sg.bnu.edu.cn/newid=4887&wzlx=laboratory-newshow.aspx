...
<div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">创客空间人才集聚的影响因素及驱动机制研究：基于北京地区的多案例分析</span></span>
                            </h3>
	...
	<tbody>
		<tr>
			...
			<td>
				创客空间人才集聚的影响因素及驱动机制研究：基于北京地区的多案例分析
			</td>
		</tr>
		<tr>
			<th>
			...
			<td>
				安乔、陈雯静、李梦真
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=4886&wzlx=laboratory" class="pres" style="float: left; width: 45%;">上一篇：外来NGO参与社区社会组织培育的一种探...</a>
                                
                            

                                    <a href="newshow.aspx?newid=4888&wzlx=laboratory" class="pres" style="float: right; width: 45%;">下一篇：反腐败有效性：中央巡视组与明朝巡按比较...</a>
