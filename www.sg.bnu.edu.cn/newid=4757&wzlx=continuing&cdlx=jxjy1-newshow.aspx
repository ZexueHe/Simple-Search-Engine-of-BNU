...
<div>
                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">我院开通“政管夜大”微信号</span></span>
                            </h3>
	...
	为便利夜大教学，向相对分散的夜大在读生及时有效传递各类信息通知，我院信息化负责老师在学校网络中心支持下，开通了“政管夜大”微信号。凡具有我院学籍的夜大在读生可采取以下步骤添加该微信号以接受信息：
</p>
<div>
	1）手机安装微信app；
</div>
<div>
	2）在“通讯录”点击“添加”按钮,进入“公众号”，输入“北京师范大学”进行搜索；
</div>
<div>
	3）选择附注有“北京师范大学官方微信门户——师大人自己的微门户”这一公众号进入。
</div>
<div>
	4）添加成功后，有消息推送时，就可以看到“政管夜大”了。&nbsp;
</div></span>
                        </div>
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=4758&wzlx=continuing" class="pres" style="float: right; width: 45%;">下一篇：2017年春季学期申请学位通知</a>
