                        ...
                        <div class="kec_s ">   
                            <h3 class="program_title" style="font-weight:bold;">
                                <span style="text-align: center; display: block; border-bottom: 1px solid #DCE6F0; color: #2C4A7E; padding-bottom: 1%">
                                    <span id="Label1">[论文]章文光：《中国行政管理》——区域创新政策差异化的实现路径与策略保障</span></span>
                            </h3>
                            ...
                            <span id="Label3">&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:14px;font-family:SimSun;line-height:1.5;">&nbsp;&nbsp;促进区域创新发展是实现建设创新型国家重大战略目标的必要途径。为保证中国创新驱动发展战略的顺利实现，大力发展不同区域多元化创新，施行以区域为基准切实有效的差异化区域创新政策成为迫切需要。本文通过对区域政策差异化的实现路径和策略保障的研究，提出区域创新政策差异化调整应以不同区域的创新基础、创新能力、创新模式为途径，基于有利于发挥区域优势和比较优势，有利于为区域不同产业创新提供高水平、深层次引导，有利于不同区域创新模式“嵌入性”与“连通性”有效融合的原则为区域创新政策差异化提供策略保障。
<hr />
</span> 
<p style="text-indent:2em;">
	<span style="font-size:14px;font-family:SimSun;line-height:1.5;">章文光、韩明.区域创新政策差异化的实现路径与策略保障.中国行政管理.2016（08）：48-55.</span> 
</p>
<p style="text-indent:2em;">
	<br />
</p>
<div>
                        ...
                        <div style="border-top: 1px solid #DCE6F0; padding: 1% 0; width: 100%; overflow: hidden; margin-top: 5%">
                                    ...
                                    <a href="newshow.aspx?newid=2565&wzlx=recent" class="pres" style="float: left; width: 45%;">上一篇：耿骞：《图书情报工作》——公共图书馆馆...</a>
