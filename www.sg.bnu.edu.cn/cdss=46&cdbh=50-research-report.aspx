                ...
                <div class="col-md-12 column">
                    <div class="row clearfix">
                        <div class="col-md-3 column  col-sm-2 col-xs-4">
                              <div class="content">
                                <h3 class="title">
                                    <span id="ctl00_ContentPlaceHolder1_Label2">学术科研</span>
                                </h3>
                                <div id="jquery-accordion-menu" class="jquery-accordion-menu red">
                                    <ul id="demo-list">
                                        
                                                <li id='a47'><a href="project.aspx?cdss=46&cdbh=47">科研项目</a></li>
                                            
                                                <li id='a48'><a href="academic.aspx?cdss=46&cdbh=48">学术论文</a></li>
                                            
                                                <li id='a49'><a href="monograph.aspx?cdss=46&cdbh=49">专著教材</a></li>
                                            
                                                <li id='a50'><a href="research-report.aspx?cdss=46&cdbh=50">研究报告</a></li>
                                            
                                                <li id='a51'><a href="system.aspx?cdss=46&cdbh=51">科研制度</a></li>
                        ...
                        <div class="col-md-9 column pn col-sm-10 col-xs-12 ">
                          <div class="url-title">
                                <b>
                                    <span id="ctl00_ContentPlaceHolder1_Label5">研究报告</span></b>
                                <ul class="breadcrumb">
                                    当前位置:
                            <li>
                                <a href="index.aspx">首页</a>
                                    ...
                                    <li>
                                            ...
                                            <span id="ctl00_ContentPlaceHolder1_Label3">学术科研</span>
                                    </li>
                                    <li class="active">
                                        <span id="ctl00_ContentPlaceHolder1_Label4">研究报告</span>
                                    </li>
                                </ul>
                            </div>
                            <!--右边标题路径导航-->
                            ...
                            <div class="ins_right ">
                                        ...
                                        <ul class="portfolio_sidebar">
                                            <li class="current">
                                                <div>
                                                    <a href="newshow.aspx?newid=4833&wzlx=rreport" target="_blank" class="">唐任伍：《2016中国民生发展报告》——精准扶贫，共享民生发展</a>
                                        ...
                                        <ul class="portfolio_sidebar">
                                            <li class="current">
                                                <div>
                                                    <a href="newshow.aspx?newid=4832&wzlx=rreport" target="_blank" class="">《2015中国民生发展报告》隆重发布</a>
                                                    <span class="date">2017-04-06</span>
                                                </div>
                                            </li>
